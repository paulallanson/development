...
type
  TfrmwtRPSOrderSchedule = class(TForm)
    ...
    qrySalesOrdersMaterials_Required: TWideStringField;
    qrySalesOrdersMaterials_Reqd_date: TSQLTimeStampField;
    qrySalesOrdersMaterials_Recd_date: TSQLTimeStampField;
    qrySalesOrdersSales_Order_Status_1: TIntegerField;
    qrySalesOrdersSales_Order_Status_Desc_1: TWideStringField;
    qrySalesOrdersDate_Type: TWideStringField;
    qrySalesOrdersTelephone_number: TWideStringField;
    qrySalesOrdersOn_Hold: TWideStringField;
