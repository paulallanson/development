...
uses
  ...
  StdCtrls, Buttons, Grids, DBGrids, DBCtrls, DB, DBTables, gtQrCtrls,
  ExtCtrls, ComCtrls;
...
type
  TfrmWTLUAddChgs = class(TForm)
    ...
    lkpExtrasUnit_Price: TFloatField;
    lkpExtrasUnit_Cost: TFloatField;
    lkpExtrasPrice_Unit_Description: TStringField;
    lkpExtrasinactive: TStringField;
