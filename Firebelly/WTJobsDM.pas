...
type
  ...
  TdtmdlJob = class(TDataModule)
    ...
    qryZero: TFDQuery;
    qryjHeader: TFDQuery;
    qryjAddHeader: TFDQuery;
    qryjUpHeader: TFDQuery;
    qryjElement: TFDQuery;
    qryjAddElement: TFDQuery;
    qryjAllElements: TFDQuery;
    qryjExtra: TFDQuery;
    qryjCutOut: TFDQuery;
    qryjEdge: TFDQuery;
    qryjAddExtra: TFDQuery;
    qryjAddCutOut: TFDQuery;
    qryjAddEdge: TFDQuery;
    qryJAllCutOuts: TFDQuery;
    qryjAllEdges: TFDQuery;
    qryJAllExtras: TFDQuery;
    qryjUpElement: TFDQuery;
    qryjUpCutOuts: TFDQuery;
    ...
    qryjUpstand: TFDQuery;
    qryjAllUpstands: TFDQuery;
    qryUpCompany: TFDQuery;
    qryJGetLast: TFDQuery;
    ...
    qryJEvent: TFDQuery;
    qryJAddEvent: TFDQuery;
    qryJAllEvents: TFDQuery;
    qryUpQuote: TFDQuery;
    qryUpSOLine: TFDQuery;
    qryUpSOStatus: TFDQuery;
    qrySOHead: TFDQuery;
    qryJUpStatus: TFDQuery;
    qryGetSO: TFDQuery;
    qryGetSOLines: TFDQuery;
    qryJRemedial: TFDQuery;
    qryJAddRemedial: TFDQuery;
    qryJAllRemedials: TFDQuery;
    qryFitter: TFDQuery;
    ...
    qryAddRemedial: TFDQuery;
    qryCheckRemedial: TFDQuery;
    qryAllJobsJob: TFloatField;
    qryAllJobsJob_Status: TIntegerField;
    qryAllJobsQuote: TIntegerField;
    qryAllJobsCustomer: TIntegerField;
    qryAllJobsContact_name: TWideStringField;
    qryAllJobsOrder_ref_no: TWideStringField;
    qryAllJobsDate_Raised: TSQLTimeStampField;
    qryAllJobsDate_Required: TSQLTimeStampField;
    qryAllJobsPayment_due: TSQLTimeStampField;
    qryAllJobsProduction_date: TSQLTimeStampField;
    qryAllJobsTemplate_date: TSQLTimeStampField;
    qryAllJobsInstallation_date: TSQLTimeStampField;
    qryAllJobsDeposit_amount: TCurrencyField;
    qryAllJobsDelivery_Price: TCurrencyField;
    qryAllJobsInstallation_price: TCurrencyField;
    qryAllJobsSurvey_price: TCurrencyField;
    qryAllJobsOperator: TIntegerField;
    qryAllJobsProduction_date_Actual: TSQLTimeStampField;
    qryAllJobsTemplate_date_actual: TSQLTimeStampField;
    qryAllJobsInstallation_date_actual: TSQLTimeStampField;
    qryAllJobsDescription: TWideStringField;
    ...
    qryAllJobsReference: TWideStringField;
    qryAllJobsNett_Price: TCurrencyField;
    qryAllJobsInactive: TWideStringField;
    qryAllJobsInactive_Reason: TIntegerField;
    qryAllJobsAddress: TIntegerField;
    qryAllJobsDiscount_Rate: TFloatField;
    qryAllJobsDiscount_Value: TCurrencyField;
    qryAllJobsCustomer_Name: TWideStringField;
    qryAllJobsInstall_Address: TIntegerField;
    qryAllJobsDeposit_Terms: TFloatField;
    qryAllJobsVAT: TIntegerField;
    qryAllJobsQuote_Nett_Price: TCurrencyField;
    qryAllJobsFitter: TIntegerField;
    qryAllJobsInstall_Name: TWideStringField;
    qryAllJobsInstall_Phone: TWideStringField;
    qryAllJobsDesigner: TIntegerField;
    qryAllJobsBranch_no: TIntegerField;
    qryAllJobsRisk_Notes: TIntegerField;
    qryAllJobsDescriptive_Reference: TWideStringField;
    qryAllJobsMarkup_Rate: TFloatField;
    qryAllJobsMarkup_Value: TFloatField;
    qryAllJobsContract_Quote: TWideStringField;
    qryAllJobsWaste_Percentage: TFloatField;
    qryAllJobsWaste_Value: TFloatField;
    qryAllJobsProject_Reference: TWideStringField;
    qryAllJobsSpecification: TIntegerField;
    qryAllJobsRisk_Assessment: TIntegerField;
    qryAllJobsMaterial_Description: TWideStringField;
    qryAllJobsStatus_Description: TWideStringField;
