...
uses
  ...
  ToolWin, DB, DBTables, wtSalesOrderDM, AllCommon, IniFiles, DateUtils, Math,
  DateSelV5;
...
uses wtDataModule, wtMain, WtMaintSalesOrder, wtRSTemplateSheet, WTRSSODeliveryNote,
...
begin
  AllCommon.SaveDBGridCols('', 'FittingLU Col Order', 'myWorktops.ini', self.dbgDetails);
  Action := caFree;
end;
...
*)
  ...
  AllCommon.SetDBGridCols('', 'FittingLU Col Order', 'myWorktops.ini', self.dbgDetails);
end;
