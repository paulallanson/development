unit wtRSSOFittingConfirm;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls, ExtCtrls, DB, DBTables, gtQrCtrls, IniFiles, allCommon;

type
  TfrmWTRSSOFittingConfirm = class(TForm)
    Label1: TLabel;
    memSelection: TMemo;
    btnPrint: TButton;
    Button4: TButton;
...
var
  frmWTRSSOFittingConfirm: TfrmWTRSSOFittingConfirm;
...
procedure TfrmWTRSSOFittingConfirm.Button4Click(Sender: TObject);
begin
  close;
end;

procedure TfrmWTRSSOFittingConfirm.btnPrintClick(Sender: TObject);
begin
  if PrintType = 'T' then
    begin
...
procedure TfrmWTRSSOFittingConfirm.RunQuoteReport(const bPreview: boolean);
begin
...
procedure TfrmWTRSSOFittingConfirm.RunReport(const bPreview: boolean);
begin
...
procedure TfrmWTRSSOFittingConfirm.RunTemplateReport(const bPreview: boolean);
begin
...
function TfrmWTRSSOFittingConfirm.GetQuoteNumber(tmpNo: integer): integer;
begin
...
procedure TfrmWTRSSOFittingConfirm.EnableRun(Sender: TObject);
begin
...
procedure TfrmWTRSSOFittingConfirm.ClearFaxArray(Sender: TObject);
var
...
procedure TfrmWTRSSOFittingConfirm.GetSelection;
var
	icount: integer;
begin
...
procedure TfrmWTRSSOFittingConfirm.BuildSelection;
var
...
procedure TfrmWTRSSOFittingConfirm.BuildRange(sFirst, sLast: string);
begin
 	with qryGetRange do
    begin
      Close;
...
procedure TfrmWTRSSOFittingConfirm.FormActivate(Sender: TObject);
begin
  iIntselcode := dtmdlWorktops.GetNextIntSelCode(Self);
end;

procedure TfrmWTRSSOFittingConfirm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  dtmdlWorktops.DelIntSelCode(iIntSelCode, True);
end;

procedure TfrmWTRSSOFittingConfirm.SetPrintType(const Value: string);
begin
  FPrintType := Value;
...
procedure TfrmWTRSSOFittingConfirm.btnPreviewClick(Sender: TObject);
begin
  if PrintType = 'T' then
    begin
...
function TfrmWTRSSOFittingConfirm.BuildQueryString: string;
var
  sTemp: string;
begin
...
procedure TfrmWTRSSOFittingConfirm.btnEmailClick(Sender: TObject);
begin
...
procedure TfrmWTRSSOFittingConfirm.EmailReport;
var
...
procedure TfrmWTRSSOFittingConfirm.FormDestroy(Sender: TObject);
var
  IniFile : TIniFile;
begin
