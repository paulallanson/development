...
type
  ...
  TdtmdlQuote = class(TDataModule)
    ...
    qryAllQuotesInstallation_price: TCurrencyField;
    qryAllQuotesDelivery_Price: TCurrencyField;
    qryAllQuotesSurvey_price: TCurrencyField;
    ...
    qryAllQuotesNett_Price: TCurrencyField;
