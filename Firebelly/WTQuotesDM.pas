...
uses
  ...
  Db, DBTables, wtNotesDM, gtQrCtrls, AllCommon, wtSupplierDM;
...
type
  ...
  TdtmdlQuote = class(TDataModule)
    ...
    qryQElement: TQuery;
    qryQAddElement: TQuery;
    qryQAllElements: TQuery;
    qryQExtra: TQuery;
    qryQCutOut: TQuery;
    qryQEdge: TQuery;
    qryQAddExtra: TQuery;
    qryQAddCutOut: TQuery;
    qryQAddEdge: TQuery;
    qryQAllCutOuts: TQuery;
    qryQAllEdges: TQuery;
    qryQAllExtras: TQuery;
    qryQUpElement: TQuery;
    qryQUpCutOuts: TQuery;
    ...
    qryAllQuotesDescription: TStringField;
    ...
    qryAllQuotesReference: TStringField;
    qryAllQuotesQuote_Status: TIntegerField;
    qryAllQuotesNett_Price: TFloatField;
    qryAllQuotesInactive: TStringField;
    qryAllQuotesOperator_Name: TStringField;
    qryAllQuotesStatus_Description: TStringField;
    qryAllQuotesCustomer_name: TStringField;
    qryAllQuotesContact_Name: TStringField;
    qryAllQuotesMaterial_Type: TIntegerField;
    qryAllQuotesMaterial_Description: TStringField;
    ...
    qryUpQuoteSO: TQuery;
    qryUpSOLine: TQuery;
    qryAllQuotesStatus_Text: TStringField;
    qryGetJob: TQuery;
    qryDesigner: TQuery;
    ...
    qryAllQuotesIs_Retail_Customer: TStringField;
    qryVat: TQuery;
    dtsVat: TDataSource;
    qryUpSOLineValues: TQuery;
    qryUpSOHead: TQuery;
    qryGetContacts: TQuery;
    qryAllQuotesImportance: TStringField;
    qryQReason: TQuery;
    ...
    qryGetLinkedQuotesAccount_Manager_Name: TStringField;
    ...
    qryAllQuotesProject_Reference: TStringField;
    qryAllQuotesCustomer_is_Speculative: TStringField;
    qryUpQuoteAddress: TQuery;
    qryGetSpeculativeQuotes: TQuery;
    qryAllQuotesExpiry_Date_New: TDateTimeField;
    qryAllQuotesExpiry_Date: TDateTimeField;
    qryDeclineQuotes: TQuery;
    qryDummyOld: TQuery;
    qryOldDummy: TQuery;
    qryQAddSlab: TQuery;
    qryQAllSlabs: TQuery;
