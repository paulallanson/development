...
type
  ...
  TdtmdlSalesInvoice = class(TDataModule)
    ...
    qrySIHeaderGridInvoice_no: TStringField;
    ...
    qrySIHeaderGridDescription: TStringField;
    qrySCHeaderGridInvoice_Date: TDateTimeField;
    qrySCHeaderGridCustomer: TIntegerField;
    qrySCHeaderGridInactive: TStringField;
    qrySCHeaderGridInvoice_or_Credit: TStringField;
    qrySCHeaderGridOriginal_Name: TStringField;
    qrySCHeaderGridStatus_Description: TStringField;
    ...
    qrySCHeaderGridInvoice_no: TStringField;
    ...
    qrySCHeaderGridDescription: TStringField;
    qrySCHeaderGridCustomer_Name: TStringField;
    ...
    qrySIHeaderGridIs_Retail_Customer: TStringField;
    qrySCHeaderGridIs_Retail_Customer: TStringField;
    ...
    qrySIHeaderGridOperator_Name: TStringField;
    qrySIHeaderGridAccount_Manager_Name: TStringField;
    qrySCHeaderBase: TFDQuery;
    qrySCHeaderGridRep_Name: TStringField;
    qrySCHeaderGridOperator_Name: TStringField;
    qrySCHeaderGridAccount_Manager_Name: TStringField;
    qrySIHeaderGridOrder_Reference: TStringField;
    qrySCHeaderGridOrder_Reference: TStringField;
    ...
    qrySCHeaderGridBranch_Name: TStringField;
    qrySIHeaderBaseOld: TFDQuery;
    qrySIHeaderGridRevenue_Centre_Descr: TStringField;
    qrySCHeaderBaseOlder: TFDQuery;
    qrySCHeaderGridRevenue_Centre_Descr: TStringField;
