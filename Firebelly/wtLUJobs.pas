...
begin
  ...
  if (Column.Title.Caption <> 'Job') and (Column.Title.Caption <> 'Supply Price') and (Column.Title.Caption <> 'Install Price') and
     (Column.Title.Caption <> 'Survey Price') and (Column.Title.Caption <> 'Delivery Price') and
     (Column.Title.Caption <> 'Quote Reference') and (Column.Title.Caption <> 'Original Quote') and
     (Column.Title.Caption <> 'Sales Order') and (Column.Title.Caption <> 'Quote No.') and
     (Column.Title.Caption <> 'Total Price incl VAT') then
  	begin
