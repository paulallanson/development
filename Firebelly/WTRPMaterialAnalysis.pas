...
uses
  ...
  Dialogs, QuickRpt, QRCtrls, gtQrCtrls, DB, DBTables, ExtCtrls;
...
type
  TfrmWTRPMaterialAnalysis = class(TForm)
    ...
    qrlblSalesTotal: TgtQRLabel;
    qrbGroupHeader2: TQRGroup;
    qrlblSortBy1: TgtQRLabel;
    qrGroupbyText1: TgtQRDBText;
    qrlblSortBy2: TgtQRLabel;
    qrGroupbyText2: TgtQRDBText;
    qrbSummary: TQRBand;
    QRLabel10: TgtQRLabel;
    qrlblReportTotal: TgtQRLabel;
    QRShape2: TgtQRShape;
    qrbGroupFooter1: TQRBand;
    qrlblSort1Total: TgtQRLabel;
    qrbGroupFooter2: TQRBand;
    qrlblSort2Total: TgtQRLabel;
    qrshpSubTotal: TgtQRShape;
    gtQRShape2: TgtQRShape;
    qrSubTotalbyText2: TgtQRDBText;
    qrTotalbyText1: TgtQRDBText;
    qrSubTotalbyText1: TgtQRDBText;
    qrlblSelection: TgtQRLabel;
    gtQRLabel4: TgtQRLabel;
    qrlblSalesCount: TgtQRLabel;
    qrlblSort2Count: TgtQRLabel;
    qrlblSort1Count: TgtQRLabel;
    qrlblReportCount: TgtQRLabel;
    gtQRLabel5: TgtQRLabel;
    qrlblArea: TgtQRLabel;
    qrlblSort2Area: TgtQRLabel;
    qrlblSort1Area: TgtQRLabel;
    qrlblReportArea: TgtQRLabel;
