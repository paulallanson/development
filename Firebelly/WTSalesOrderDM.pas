...
type
  ...
  TdtmdlSalesOrder = class(TDataModule)
    ...
    qryAllSalesOn_Hold: TWideStringField;
    qryAllSalesEmail_Address: TWideStringField;
    qryAllSalesAccount_Manager: TIntegerField;
    qryAllSalesDescriptive_Reference: TWideStringField;
    qryAllSalesTemplate_Duration: TIntegerField;
    qryAllSalesFitting_Duration: TIntegerField;
    qryAllSalesFitter: TIntegerField;
    qryAllSalesIs_In_Outlook: TWideStringField;
    qryAllSalesIsFittingInOutlook: TWideStringField;
    qryAllSalesIsTemplateInOutlook: TWideStringField;
    qryAllSalesTemplater: TIntegerField;
    qryAllSalesSupply_Only: TWideStringField;
    qryAllSalesProject_Reference: TWideStringField;
    qryAllSalesPaid_Status: TWideStringField;
    qryAllSalesContact_no: TIntegerField;
    qryAllSalesAppliance_Details: TWideStringField;
    qryAllSalesLocation_Plan_Document: TWideStringField;
    qryAllSalesSSMA_TimeStamp: TBytesField;
    qryAllSalesCollection_Only: TWideStringField;
    qryAllSalesInstallation_Address: TIntegerField;
    qryAllSalesTemplate_Docs_Returned: TWideStringField;
    qryAllSalesFitting_Docs_Returned: TWideStringField;
    qryAllSalesRevenue_Centre: TIntegerField;
    ...
    qryAllSalesOriginal_Sales_Order: TIntegerField;
    qryAllSalesRemedial_ID: TIntegerField;
    qryAllSalesInv_Customer: TIntegerField;
    qryAllSalesBranch_no: TIntegerField;
    qryAllSalesDo_not_invoice: TWideStringField;
    qryAllSalesoriginal_customer_name: TWideStringField;
    qryAllSalesis_retail_customer: TWideStringField;
