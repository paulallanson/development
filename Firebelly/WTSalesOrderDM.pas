...
type
  ...
  TdtmdlSalesOrder = class(TDataModule)
    ...
    qrySOGetLast: TQuery;
    qrySOHeader: TQuery;
    qrySOAllLines: TQuery;
    qryOperator: TQuery;
    dtsOperator: TDataSource;
    qryUpCompany: TQuery;
    qrySOAddHeader: TQuery;
    qrySOUpHeader: TQuery;
    qrySOLine: TQuery;
    qrySOAddLine: TQuery;
    qryRep: TQuery;
    dtsRep: TDataSource;
    ...
    qryAllSalesReference: TStringField;
    qryAllSalesExtra_Notes: TIntegerField;
    qryAllSalesOperator: TIntegerField;
    qryAllSalesContact_Name: TStringField;
    qryAllSalesOrder_ref_no: TStringField;
    ...
    qryAllSalesInactive: TStringField;
    qryAllSalesCustomer_Name: TStringField;
    qryAllSalesInactive_Reason: TIntegerField;
    qryAllSalesAddress: TIntegerField;
    qryAllSalesTemplate_Date: TDateTimeField;
    qryAllSalesoriginal_customer_name: TStringField;
    qryAllSalesOperator_name: TStringField;
    qryAllSalesTotal_Value: TFloatField;
    qryAllSalessales_order_status_desc: TStringField;
    qryCustQuotes: TQuery;
    dsCustQuotes: TDataSource;
    dsDummy: TDataSource;
    qryGetQuoteJob: TQuery;
    qryGetSOLines: TQuery;
    qrySOUpStatus: TQuery;
    qryAllSalesOn_Hold: TStringField;
    qryAllSalesStatus_Text: TStringField;
    qrySOUpdLine: TQuery;
    qryGetSOrderInvoices: TQuery;
    qrySetSOrderInactive: TQuery;
    qryUpCustomer: TQuery;
    qryUpQuote: TQuery;
    qryAllSalesDescriptive_Reference: TStringField;
    qryAllSalesTemplate_Date_New: TStringField;
    qryAllSalesFitting_Date_New: TStringField;
    qrySOUpSalesInvoice: TQuery;
    qryAllSalesOffice_Contact_Name: TStringField;
    qryAllSalesIs_Retail_Customer: TStringField;
    qryGetLinkedQuotes: TQuery;
    ...
    qryGetLinkedQuotesDescription: TStringField;
    qryGetLinkedQuotesOriginal_Quote: TIntegerField;
    qryGetLinkedQuotesOperator_Name: TStringField;
    qryGetLinkedQuotesInstallation_price: TFloatField;
    qryGetLinkedQuotesDelivery_Price: TFloatField;
    qryGetLinkedQuotesSurvey_price: TFloatField;
    qryGetLinkedQuotesComplete_Price: TFloatField;
    qryGetLinkedQuotesTotal_Price: TFloatField;
    qryGetLinkedQuotesQuote_status_description: TStringField;
    qryGetLinkedQuotesMaterial_Type_Description: TStringField;
    qryGetSOHead: TQuery;
    qryFitter: TQuery;
    qryTemplater: TQuery;
    ...
    qrySOEvent: TQuery;
    qrySOAddEvent: TQuery;
    qrySOAllEvents: TQuery;
    qryQAllEvents: TQuery;
    qryAllSalesProject_Reference: TStringField;
    qryAllSalesCustomer_is_Speculative: TStringField;
    qryUpQuoteVersions: TQuery;
    qryGetQuote: TQuery;
    qryQuoteSlabs: TQuery;
    qrySOPurchases: TQuery;
    dtsSOPurchases: TDataSource;
    qrySOPurchasesPurchase_Order: TIntegerField;
    qrySOPurchasesLine_no: TIntegerField;
    qrySOPurchasesPO_Line_Description: TStringField;
    qrySOPurchasesUnit_cost: TFloatField;
    ...
    qrySOPurchasesOperator_Name: TStringField;
    qrySOPurchasesOffice_Contact: TIntegerField;
    qrySOPurchasesOffice_Contact_Name: TStringField;
    qrySOPurchasesInactive: TStringField;
    qrySOPurchasesOn_Hold: TStringField;
    qrySOPurchasesSupplier: TIntegerField;
    qrySOPurchasesSupplier_name: TStringField;
    qrySOPurchasesContact_no: TIntegerField;
    qrySOPurchasesContact_name: TStringField;
    qrySOPurchasesGRN_Number: TStringField;
    ...
    qrySOPurchasesSlab_Description: TStringField;
    qrySOPurchasesSlab_Size_Description: TStringField;
    qrySOPurchasesPurchase_Order_Status: TIntegerField;
    qrySOPurchasesStatus_Description: TStringField;
    qrySOPurchasesTotal_Cost: TCurrencyField;
    qryRemovePO: TQuery;
    qryDeletePO: TQuery;
    qryAllSalesDeposit_Required: TFloatField;
    qryGetCustomerContact: TQuery;
    qryGetSOSlabs: TQuery;
    qryGetPurchases: TQuery;
    qryAllSalesDate_Type: TStringField;
    qryGetSOrderEmail: TQuery;
    qryGetQuoteSlabs: TQuery;
    dtsGetQuoteSlabs: TDataSource;
    qrySOPurchasesQuantity: TFloatField;
    qryAllSalesQuote: TIntegerField;
    qryAllSalesTemplater_Name: TStringField;
    qryAllSalesFitter_Name: TStringField;
    qrySalesInvoices: TQuery;
    dtsSalesInvoices: TDataSource;
    qryUpQuoteCustomer: TQuery;
    qryUpJobCustomer: TQuery;
    qryAllSalesAccount_Code: TStringField;
    qryGetSOLQuoteNo: TQuery;
    qryJobs: TQuery;
    dtsJobs: TDataSource;
    qryRemedials: TQuery;
    dtsRemedials: TDataSource;
    qryJobsDummy: TQuery;
    qryAllSalesTemplate_Docs_Returned: TStringField;
    qryAllSalesFitting_Docs_Returned: TStringField;
    qrySOUpTemplate: TQuery;
    qryAllSalesJob: TFloatField;
    qrySOUpFitting: TQuery;
    ...
    qryAllSalesRemedial_Production: TStringField;
    qryAllSalesRemedial_No_Production: TStringField;
    qryRemedialCount: TQuery;
    qryAllSalesSales_Order_Number: TFloatField;
    qryRemedialReport: TQuery;
    qryJobsDummyOlder: TQuery;
    qrySOUpRemedial: TQuery;
    qryJobsDummyOld: TQuery;
