...
//  qrlblCompanyAdd.Enabled := qriHeadLogo.enabled;
  ...
  qrcbTerms.enabled := (trim(qrrchtextTerms.lines[0]) <> '');
...
begin
  ...
  tempAddress := tempAddress + '  Email:  ' + qryCompany.Fieldbyname('Email_Address').AsString;
  tempAddress := tempAddress + '  Web:  ' + qryCompany.Fieldbyname('Web_Address').AsString;
