...
type
  TfrmWTRPPOOrdersDue = class(TForm)
...
var
  frmWTRPPOOrdersDue: TfrmWTRPPOOrdersDue;

implementation

uses wtDataModule, WTRSPOOrdersDue;

{$R *.dfm}

procedure TfrmWTRPPOOrdersDue.qrpDetailsBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  case sortby of
    0:begin
...
procedure TfrmWTRPPOOrdersDue.qrsbDetailsBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmWTRPPOOrdersDue.qrbGroupFooterAfterPrint(
...
procedure TfrmWTRPPOOrdersDue.qrbGroupFooterBeforePrint(
...
function TfrmWTRPPOOrdersDue.GetDetails: integer;
var
  iCount: integer;
  { Local function }
...
procedure TfrmWTRPPOOrdersDue.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmWTRPPOOrdersDue.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  ReportTotal := 0.00;
end;

procedure TfrmWTRPPOOrdersDue.ExporttoFile(filename: string);
var
  tempStr: string;
begin
  self.exporting := true;
...
procedure TfrmWTRPPOOrdersDue.qrsbDetailsAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var
  tempstr: string;
begin
  ...
  begin
    ...
    writeln(self.exportFile, tempStr);
    frmWTRSPOOrdersDue.prgbrExport.StepIt;
  end;
end;

procedure TfrmWTRPPOOrdersDue.FormCreate(Sender: TObject);
begin
  SupplierList := TStringList.Create;
end;

procedure TfrmWTRPPOOrdersDue.FormDestroy(Sender: TObject);
begin
  SupplierList.Free;
end;
