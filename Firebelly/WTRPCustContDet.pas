unit WTRPCustContDet;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  Qrctrls, QuickRpt, Db, DBTables, ExtCtrls, AllCommon;

type
  TfrmWTRPCustContDet = class(TForm)
    ...
    GetDetsQryContact_Name: TStringField;
    GetDetsQryTitle: TStringField;
    GetDetsQryForename: TStringField;
    GetDetsQryEmail_address: TStringField;
    GetDetsQryContact_Phone: TStringField;
    GetDetsQryMobile_Number: TStringField;
    GetDetsQryContact_Fax: TStringField;
    GetDetsQryContact_Type: TIntegerField;
    GetDetsQryContact_Type_Description: TStringField;
    GetDetsQryStreet: TStringField;
    GetDetsQryLocale: TStringField;
    GetDetsQryTown_City: TStringField;
    GetDetsQryPostcode: TStringField;
    GetDetsQryCounty_State: TStringField;
    GetDetsQryCustomer_Phone: TStringField;
    GetDetsQryCustomer_Fax: TStringField;
    GetDetsQryCustomer_Name: TStringField;
    GetDetsQryCustomer: TIntegerField;
    GetDetsQryinactive: TStringField;
    GetDetsQryRep: TIntegerField;
    GetDetsQryCustomer_Type_Description: TStringField;
    GetDetsQryRep_Name: TStringField;
...
procedure TfrmWTRPCustContDet.QRPCustStatBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TfrmWTRPCustContDet.GetDetsQryPhoneGetText(Sender: TField;
...
procedure TfrmWTRPCustContDet.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tempStr: string;
begin
