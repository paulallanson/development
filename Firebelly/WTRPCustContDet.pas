...
type
  TfrmWTRPCustContDet = class(TForm)
    ...
    GetDetsQryTitle: TWideStringField;
    GetDetsQryForename: TWideStringField;
    GetDetsQryEmail_address: TWideStringField;
    GetDetsQryContact_Phone: TWideStringField;
    GetDetsQryMobile_Number: TWideStringField;
    ...
    GetDetsQryTown_City: TWideStringField;
    GetDetsQryPostcode: TWideStringField;
    GetDetsQryCounty_State: TWideStringField;
    ...
    GetDetsQryCustomer_Type_Description: TWideStringField;
