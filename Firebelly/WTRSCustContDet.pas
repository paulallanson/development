...
type
  TfrmWTRSCustContDet = class(TForm)
    ...
    qryCurrentContStatusTitle: TStringField;
    qryCurrentContStatusForename: TStringField;
    qryCurrentContStatusEmail_address: TStringField;
    qryCurrentContStatusContact_Phone: TStringField;
    qryCurrentContStatusMobile_Number: TStringField;
    ...
    qryCurrentContStatusTown_City: TStringField;
    qryCurrentContStatusPostcode: TStringField;
    qryCurrentContStatusCounty_State: TStringField;
