...
uses
  ...
  Dialogs, ExtCtrls, QuickRpt, QRCtrls, DB, StdCtrls, Math,
...
type
  TfrmwtRPJob = class(TForm)
    ...
    lblWTTotal: TQRLabel;
    lblCOPrice: TQRLabel;
    lblEdgePrice: TQRLabel;
    lblCOTotal: TQRLabel;
    lblEdgeTotal: TQRLabel;
    qrlblWorktop: TQRLabel;
    qrlblCutOuts: TQRLabel;
    qrlblEdgeDetails: TQRLabel;
    ...
    qrlbldesignerLabel: TQRLabel;
    qrlblDesigner: TQRLabel;
    gtQRShape1: TQRShape;
    gtQRLabel1: TQRLabel;
    qrlblTemplateDate: TQRLabel;
    qrlblProductionDate: TQRLabel;
