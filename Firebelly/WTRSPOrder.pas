...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, IniFiles, DB, DBTables;
...
begin
    ...
    begin
      Close;
      ParamByName('From_Purchase_Order').AsFloat := StrtoFloat(sFirst);
      ParamByName('To_Purchase_Order').AsFloat := StrtoFloat(sLast);
      Open;
      First;
      While Not EOF do
        begin
