...
type
  TfrmwtRPSOrderTemplate = class(TForm)
    ...
    qrySalesOrdersNett_Price: TCurrencyField;
    qrySalesOrdersDiscount_Value: TCurrencyField;
    qrySalesOrdersInstallation_price: TCurrencyField;
    qrySalesOrdersSurvey_price: TCurrencyField;
    qrySalesOrdersDelivery_Price: TCurrencyField;
    qrySalesOrdersMarkup_Value: TFloatField;
    qrySalesOrdersWaste_Value: TFloatField;
    qrySalesOrdersVat: TIntegerField;
    qrySalesOrdersDescription: TWideStringField;
    ...
    qrySalesOrdersSales_Order_Status_1: TIntegerField;
    qrySalesOrdersIsTemplateInOutlook: TWideStringField;
    qrySalesOrdersSales_Order_Status_Desc_1: TWideStringField;
    ...
    OLDqrySalesOrdersSales_Order: TIntegerField;
    OLDqrySalesOrdersSales_order_Line_no: TIntegerField;
    OLDqrySalesOrdersNett_Price: TCurrencyField;
    OLDqrySalesOrdersDiscount_Value: TCurrencyField;
    OLDqrySalesOrdersInstallation_price: TCurrencyField;
    OLDqrySalesOrdersSurvey_price: TCurrencyField;
    OLDqrySalesOrdersDelivery_Price: TCurrencyField;
    OLDqrySalesOrdersMarkup_Value: TFloatField;
    OLDqrySalesOrdersWaste_Value: TFloatField;
    OLDqrySalesOrdersVat: TIntegerField;
    OLDqrySalesOrdersDescription: TWideStringField;
    OLDqrySalesOrdersVat_Rate: TFloatField;
    ...
    OLDqrySalesOrdersInstall_Address: TIntegerField;
    OLDqrySalesOrdersCustomer_Name: TWideStringField;
    OLDqrySalesOrdersReference: TWideStringField;
    OLDqrySalesOrdersSales_Order_Status_1: TIntegerField;
    OLDqrySalesOrdersIsTemplateInOutlook: TWideStringField;
    OLDqrySalesOrdersSales_Order_Status_Desc_1: TWideStringField;
    OLDqrySalesOrdersTelephone_number: TWideStringField;
    OLDqrySalesOrdersIs_Retail_Customer: TWideStringField;
    OLDqrySalesOrdersIs_Commercial_Customer: TWideStringField;
    OLDqrySalesOrdersRep: TIntegerField;
    OLDqrySalesOrdersRep_Name: TWideStringField;
