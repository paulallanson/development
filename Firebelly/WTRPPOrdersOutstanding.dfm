object frmWTRPPOrdersOutstanding: TfrmWTRPPOrdersOutstanding
  Left = 86
  Top = 103
  Width = 1177
  Height = 615
  Caption = 'Outstanding Purchase Order Report'
  Color = clBtnFace
  ...
  object qryReport: TQuery
    ...
    SQL.Strings = (
      ...
      '(Purchase_Order.Purchase_Order_Status < 50) and'
        ...
        '((Purchase_Order.Date_Raised >= :Date_From) and (Purchase_Order.' +
        'Date_Raised <= :Date_To))'
      '')
    Left = 208
    Top = 184
