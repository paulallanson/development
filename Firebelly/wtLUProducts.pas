...
type
  TfrmWTLUProducts = class(TForm)
    ...
    lkpProductsProduct_Description: TWideStringField;
    lkpProductsProduct_code: TWideStringField;
    lkpProductsPrice_pointer: TIntegerField;
    lkpProductsDefault_sales_nominal: TWideStringField;
    lkpProductsDefault_purchase_nominal: TWideStringField;
    lkpProductsVat: TIntegerField;
    lkpProductsProduct_Group: TIntegerField;
    lkpProductsinactive: TWideStringField;
    lkpProductsUnit_Price: TCurrencyField;
    lkpProductsUnit_Cost: TCurrencyField;
    lkpProductsPrice_Unit_Description: TWideStringField;
    lkpProductsVat_Rate: TFloatField;
    lkpProductsVat_Description: TWideStringField;
    lkpProductsProduct_Group_Description: TWideStringField;
