...
type
  ...
  TdtmdlPurchaseOrder = class(TDataModule)
    ...
    qryAllPurchasesSupplier_Name: TStringField;
    ...
    qryAllPurchasesReference: TStringField;
    qryAllPurchasesOn_Hold: TStringField;
    qryAllPurchasesinactive: TStringField;
    qryAllPurchasesGoods_Value: TFloatField;
    qryAllPurchasesOperator_Name: TStringField;
    qryAllPurchasesGoods_Receipt_Number: TStringField;
    qryAllPurchasesPurchase_Order_Status: TIntegerField;
    qryAllPurchasesStatus_Description: TStringField;
