...
//  qrlblCompanyName.caption := qryCompanyAddress.fieldbyname('Company_Name').asstring;
  ...
  if qryCompanyAddress.fieldbyname('Email_Address').AsString <> '' then
    begin
      tempAddress := tempAddress + #13#10;
      tempAddress := tempAddress + qryCompanyAddress.fieldbyname('Email_Address').AsString;
    end;

  if qryCompanyAddress.fieldbyname('Web_Address').AsString <> '' then
    begin
      tempAddress := tempAddress + #13#10;
      tempAddress := tempAddress + qryCompanyAddress.fieldbyname('Web_Address').AsString;
    end;
...
begin
  ...
  with qrySOHead do
    begin
      ...
      qrlblProject.caption := fieldbyname('Project_Reference').asstring;
