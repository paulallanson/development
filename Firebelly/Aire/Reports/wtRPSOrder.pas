...
type
  TfrmwtRPSOrder = class(TForm)
    ...
    qrySOLineUnit_price: TCurrencyField;
    qrySOLineQuantity: TIntegerField;
    qrySOLineSell_Unit: TIntegerField;
    qrySOLineTotal_Price: TCurrencyField;
    qrySOLineNett_Price: TCurrencyField;
    qrySOLineDiscount_Value: TCurrencyField;
    qrySOLineInstallation_price: TCurrencyField;
    qrySOLineSurvey_price: TCurrencyField;
    qrySOLineDelivery_Price: TCurrencyField;
