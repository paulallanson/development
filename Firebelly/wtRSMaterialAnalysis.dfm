object frmWTRSMaterialAnalysis: TfrmWTRSMaterialAnalysis
  Left = 399
  Top = 91
  ...
  object qrySOReport: TQuery
    ...
    SQL.Strings = (
      ...
      '        ON Operator.Operator = Sales_Order.Account_Manager'
        ...
        'WHERE Sales_Order.Date_Raised >= :Date_From AND Sales_Order.Date' +
        '_Raised <= :Date_To'
      'GROUP BY'
      '        Worktop.Worktop,'
  ...
  object qrySIReport: TQuery
    ...
    SQL.Strings = (
      ...
      '      INNER JOIN Sales_invoice_line'
        ...
        '        ON (Sales_Order_Line.Sales_Order = Sales_invoice_line.Sa' +
        'les_Order) AND (Sales_Order_Line.Sales_order_Line_no = Sales_inv' +
        'oice_line.Sales_Order_Line_no))'
      '        ON Material_Type.Material_Type = Worktop.Material_Type)'
      ...
      '        ON Customer.Customer = Sales_invoice.Customer'
        ...
        'WHERE Sales_Invoice.Invoice_Date >= :Date_From AND Sales_Invoice' +
