...
type
  TfrmwtRPQuoteSummary = class(TForm)
    ...
    lblOptionComplete: TgtQRLabel;
    gtQRLabel5: TgtQRLabel;
    gtQRLabel6: TgtQRLabel;
    gtQRLabel7: TgtQRLabel;
    gtQRLabel8: TgtQRLabel;
    lblOptionVAT: TgtQRLabel;
    lblOptionTotal: TgtQRLabel;
...
begin
  ...
  if iRowCount = 1 then
    sDescription := 'Worktop Elements Sizes (mm)   - ';

  if qryQElements.fieldbyname('Thickness_mm').asstring <> sWorktop then
    begin
      sWorktop := qryQElements.fieldbyname('Thickness_mm').asstring;
      sDescription := sDescription + qryQElements.fieldbyname('Thickness_mm').asstring + ' ';
    end
  else
    sDescription := '';
