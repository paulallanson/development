...
var
  frmWTAccExportFactInvs: TfrmWTAccExportFactInvs;

implementation

uses
  DateSelV5, AllCommon, wtMain;

{$R *.DFM}

procedure TfrmWTAccExportFactInvs.btnDateFromClick(Sender: TObject);
var
...
procedure TfrmWTAccExportFactInvs.btnDateToClick(Sender: TObject);
var
  DateSelV5Form: TDateSelV5Form;
begin
  DateSelV5Form := TDateSelV5Form.Create(Self);
...
procedure TfrmWTAccExportFactInvs.edtDateFromExit(Sender: TObject);
var
  NewDate: TDateTime;
begin
...
procedure TfrmWTAccExportFactInvs.edtDateToExit(Sender: TObject);
var
  NewDate: TDateTime;
begin
...
procedure TfrmWTAccExportFactInvs.btnExportClick(Sender: TObject);
var
  tempStr: string;
  exportOK: boolean;
begin
...
procedure TfrmWTAccExportFactInvs.ExportInvs;
var
  factorFile: TextFile;
  tempStr: string;
begin
...
procedure TfrmWTAccExportFactInvs.btnBrowseClick(Sender: TObject);
begin
...
procedure TfrmWTAccExportFactInvs.btnCancelClick(Sender: TObject);
begin
  self.ModalResult := mrCancel;
end;

procedure TfrmWTAccExportFactInvs.rdgrpExportByClick(Sender: TObject);
begin
...
procedure TfrmWTAccExportFactInvs.FormShow(Sender: TObject);
begin
...
procedure TfrmWTAccExportFactInvs.rdgrpInvOrCredClick(Sender: TObject);
begin
...
procedure TfrmWTAccExportFactInvs.BuildSelection;
var
...
procedure TfrmWTAccExportFactInvs.BuildRange(sFirst, sLast: string);
begin
...
procedure TfrmWTAccExportFactInvs.DelIntSelCode(iTempIntSelCode: Integer;
...
procedure TfrmWTAccExportFactInvs.GetSelection;
var
	icount: integer;
begin
...
function TfrmWTAccExportFactInvs.GetNextIntSelCode(
...
procedure TfrmWTAccExportFactInvs.UpdateInvs;
var
  fileName: string;
  theTime: TDateTime;
begin
...
function TfrmWTAccExportFactInvs.ParseFileName(path: string): string;
var
  inx: integer;
begin
  inx := pos('\', path);
...
function TfrmWTAccExportFactInvs.ParsePathName(path: string): string;
var
  inx: integer;
  tempStr: string;
begin
...
procedure TfrmWTAccExportFactInvs.SavePath;
var
  tempStr: String;
  IniFile : TIniFile;
begin
...
function TfrmWTAccExportFactInvs.GetPath: string;
var
  IniFile : TIniFile;
begin
  IniFile := TIniFile.Create(frmWTMain.AppIniFile);
