...
type
  TfrmWtLUWTGroupPrices = class(TForm)
    ...
    lkpWTGPricesThickness_mm: TWideStringField;
    lkpWTGPricesWorktop_Group_Description: TWideStringField;
    lkpWTGPricesMaterial_Description: TWideStringField;
...
uses
  System.UITypes,
  WTMaintWTGPrices, wtDataModule, wtMain, wtLUMatType;
