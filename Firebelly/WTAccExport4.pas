...
var
  frmWTAccExport4: TfrmWTAccExport4;
...
procedure TfrmWTAccExport4.BitBtn1Click(Sender: TObject);
begin
  frmWTAccExport1.close;
end;

procedure TfrmWTAccExport4.FormShow(Sender: TObject);
begin
  Caption := frmWTAccExport1.ActionListBox.Items[frmWTAccExport1.ActionListBox.Itemindex];
  if frmWTAccExport1.ActionListBox.Itemindex < 5 then
