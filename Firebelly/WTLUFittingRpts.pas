...
type
  TfrmWTLUFittingRpts = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    btnselect: TButton;
    Button2: TButton;
...
var
  frmWTLUFittingRpts: TfrmWTLUFittingRpts;
...
procedure TfrmWTLUFittingRpts.Button2Click(Sender: TObject);
begin
  close;
end;

procedure TfrmWTLUFittingRpts.btnselectClick(Sender: TObject);
var
  sTemp: string;
begin
...
procedure TfrmWTLUFittingRpts.RunReport(TempForm: string);
begin
...
procedure TfrmWTLUFittingRpts.enableSelect(Sender: TObject);
begin
  btnSelect.enabled := (lstvwReports.SelCount > 0);
end;

procedure TfrmWTLUFittingRpts.lstvwReportsDblClick(Sender: TObject);
begin
