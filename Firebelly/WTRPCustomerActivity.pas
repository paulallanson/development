...
type
  TfrmwtRPCustomerActivity = class(TForm)
    ...
    qrlblTotalQuoteCount: TgtQRLabel;
    QRShape2: TgtQRShape;
    qrlblDateRange: TgtQRLabel;
    QRSysData2: TgtQRSysData;
    qrlblTotalOrderCount: TgtQRLabel;
    gtQRLabel1: TgtQRLabel;
    qryActivity: TQuery;
    qryQuotes: TQuery;
    qrySOrders: TQuery;
    gtQRLabel2: TgtQRLabel;
    qrlblLastActivity: TgtQRLabel;
    qrlblQuoteCount: TgtQRLabel;
    gtQRLabel3: TgtQRLabel;
    gtQRLabel4: TgtQRLabel;
    qrlblSOrderCount: TgtQRLabel;
    qrlblSOrderValue: TgtQRLabel;
    qrlblSInvoiceCount: TgtQRLabel;
    qrlblSInvoiceValue: TgtQRLabel;
    gtQRLabel7: TgtQRLabel;
    gtQRLabel8: TgtQRLabel;
    qrySInvoices: TQuery;
    gtQRLabel5: TgtQRLabel;
    qrlblCustomerCount: TgtQRLabel;
    qrlblGrpQuoteCount: TgtQRLabel;
    qrlblGrpOrderCount: TgtQRLabel;
    QRShape1: TQRShape;
    qrlblGrpOrderValue: TgtQRLabel;
    qrlblGrpInvoicecount: TgtQRLabel;
    qrlblGrpInvoicevalue: TgtQRLabel;
    qrlblTotalOrderValue: TgtQRLabel;
    qrlblTotalInvoiceCount: TgtQRLabel;
    qrlblTotalInvoiceValue: TgtQRLabel;
    gtQRLabel9: TgtQRLabel;
    qrlblTotalCustomerCount: TgtQRLabel;
