...
uses
  ...
  QuickRpt, QRExpr, Qrctrls, StdCtrls, DB, DBTables, ExtCtrls, AllCommon, Math, gtQrCtrls;
...
type
  TfrmWTRPSalesInvoice = class(TForm)
    ...
    qrshpLeft: TgtQRShape;
    qrshpRight: TgtQRShape;
    qrLineLeft: TgtQRShape;
    qrLineRight: TgtQRShape;
    qrLine1: TgtQRShape;
    qrLine2: TgtQRShape;
    ...
    begin
      ...
      for icount := 0 to 4 do
        begin
          ...
          Lines.Append(Trim(qryCompanyAddress.Fields[icount].AsString)) ;
        end;
      Lines.Append(Trim('Tel:  ' + qryCompanyAddress.Fields[5].AsString));
      Lines.Append(Trim('  Fax:  ' + qryCompanyAddress.Fields[6].AsString));
    end;
