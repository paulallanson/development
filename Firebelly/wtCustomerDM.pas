...
type
  TdtmdlCustomers = class(TDataModule)
    ...
    qrySOrdersDate_Raised: TSQLTimeStampField;
    qrySOrdersDate_Required: TSQLTimeStampField;
    ...
    qrySOrdersTemplate_Date: TSQLTimeStampField;
    qrySOrdersDate_Type: TWideStringField;
    qrySOrdersMaterials_Required: TWideStringField;
    qrySOrdersMaterials_Reqd_Date: TSQLTimeStampField;
    qrySOrdersMaterials_Recd_Date: TSQLTimeStampField;
    ...
    qryJobsDate_Raised: TSQLTimeStampField;
    qryJobsDate_Required: TSQLTimeStampField;
    qryJobsPayment_due: TSQLTimeStampField;
    qryJobsProduction_date: TSQLTimeStampField;
    qryJobsTemplate_date: TSQLTimeStampField;
    qryJobsInstallation_date: TSQLTimeStampField;
    ...
    qryJobsProduction_date_Actual: TSQLTimeStampField;
    qryJobsTemplate_date_actual: TSQLTimeStampField;
    qryJobsInstallation_date_actual: TSQLTimeStampField;
    ...
    qryInvoicesInvoice_Date: TSQLTimeStampField;
