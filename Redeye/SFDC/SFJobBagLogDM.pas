...
type
  TdtmdlJobBagLog = class(TDataModule)
    ...
    qryJobLogGridJob_Bag_Description: TStringField;
    qryJobLogGridCustomer: TIntegerField;
    qryJobLogGridBranch_No: TIntegerField;
    qryJobLogGridCustomer_Name: TStringField;
    qryJobLogGridDate_Point: TDateTimeField;
    qryJobLogGridProcess_Group: TIntegerField;
    qryJobLogGridProcess_Group_Description: TStringField;
    qryJobLogGridProcess: TIntegerField;
    qryJobLogGridProcess_Description: TStringField;
    qryJobLogGridWork_Centre: TIntegerField;
    qryJobLogGridWork_Centre_Name: TStringField;
    qryJobLogGridPaper_Size: TIntegerField;
    qryJobLogGridPaper_Size_Description: TStringField;
    qryJobLogGridCustom_Paper_Size: TStringField;
    qryJobLogGridNumber_Up: TIntegerField;
    qryJobLogGridLaser_Format: TStringField;
    qryJobLogGridQuantity: TFloatField;
    qryJobLogGridOperator: TIntegerField;
    qryJobLogGridOperator_Name: TStringField;
    qryJobLogGridAudit_Workstation: TStringField;
