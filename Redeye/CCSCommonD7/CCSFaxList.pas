...
var
  CCSFaxListFrm: TCCSFaxListFrm;

implementation

{$R *.DFM}

procedure TCCSFaxListFrm.FormCreate(Sender: TObject);
begin
	FaxListgrid.cells[2,0] := 'Fax Number';
end;

procedure TCCSFaxListFrm.FaxListGridSelectCell(Sender: TObject; ACol, ARow: Integer; var CanSelect: Boolean);
begin
	if ACol = 2 then
...
procedure TCCSFaxListFrm.FaxListGridKeyPress(Sender: TObject;
  var Key: Char);
begin
	case Ord(key) of
  	$30..$39:;
