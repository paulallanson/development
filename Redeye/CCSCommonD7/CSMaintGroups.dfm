object CSMaintGroupsFrm: TCSMaintGroupsFrm
  ...
  object GetCustTypesSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select Customer_Type.Customer_Type, Customer_Type.Description'
      'From Customer_Type'
      'Order By Customer_Type.Description')
    Left = 136
    Top = 24
  end
  ...
  object GetCountriesSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
  ...
  object GetCurrencySQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
  ...
  object GetIntrastatsSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select Intrastat_Id, Intrastat_Id_Descr'
      'From Intrastat_Id'
      'Order By Intrastat_Id_Descr')
    Left = 88
    Top = 264
  end
