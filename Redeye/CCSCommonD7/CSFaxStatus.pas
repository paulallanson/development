...
var
  frmCSFaxStatus: TfrmCSFaxStatus;
...
procedure TfrmCSFaxStatus.FaxDatabaseError(ASender, AInitiator: TObject; var AException: Exception);
begin
  ParseException(AException);
end;

procedure TfrmCSFaxStatus.FormActivate(Sender: TObject);
begin
...
procedure TfrmCSFaxStatus.ShowFaxesDBGridColEnter(Sender: TObject);
var
  Status: string[1];
begin
...
procedure TfrmCSFaxStatus.ReadFaxes(Sender: TObject);
begin
  {Re-read the fax que};
...
procedure TfrmCSFaxStatus.CancelFaxBitBtnClick(Sender: TObject);
begin
  with UpdFaxQuery do
  begin
    Close;
...
procedure TfrmCSFaxStatus.DisableButtons(Sender: TObject);
begin
  CancelFaxBitBtn.Enabled := False;
  ReQueFaxBitBtn.Enabled := False;
end;

procedure TfrmCSFaxStatus.ReQueFaxBitBtnClick(Sender: TObject);
begin
  with UpdFaxQuery do
  begin
    Close;
...
procedure TfrmCSFaxStatus.ReFreshBitBtnClick(Sender: TObject);
begin
  FormActivate(Self);
end;
...
procedure TfrmCSFaxStatus.BitBtn1Click(Sender: TObject);
begin
  close;
end;

procedure TfrmCSFaxStatus.Timer1Timer(Sender: TObject);
begin
  FormActivate(self);
end;
