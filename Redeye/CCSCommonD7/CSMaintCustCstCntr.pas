...
var
  CsMaintCustCstCntrFrm: TCsMaintCustCstCntrFrm;
...
procedure TCsMaintCustCstCntrFrm.FormActivate(Sender: TObject);
begin
{Setup titles} ;
CustLabel.Caption := 'Customer: ' + CSLUCustCstCntrFrm.sCustName;
...
If sFuncMode = 'A' then
   ...
   begin
   With CSLUCustCstCntrFrm.DetsSRC.DataSet do
        begin
...
procedure TCsMaintCustCstCntrFrm.CheckOK(Sender: TObject);
begin
...
procedure TCsMaintCustCstCntrFrm.CancelBitBtnClick(Sender: TObject);
begin
Close ;
end;

procedure TCsMaintCustCstCntrFrm.OKBitBtnClick(Sender: TObject);
begin
If sFuncMode = 'A' then
   begin
...
procedure TCsMaintCustCstCntrFrm.CstCntrEditChange(Sender: TObject);
begin
CheckOk(Self);
end;

procedure TCsMaintCustCstCntrFrm.DescEditChange(Sender: TObject);
begin
CheckOK(Self);
end;

function TCsMaintCustCstCntrFrm.uniquecentre(iCust: integer;
