object PBLUQuoteReasonFrm: TPBLUQuoteReasonFrm
  Left = 272
  Top = 155
  BorderStyle = bsDialog
  Caption = 'Quote Lost/Won Reason'
  ClientHeight = 317
  ClientWidth = 432
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Quote_Reason_Description'
  ...
  object rdgReasonType: TRadioGroup
    Left = 336
    Top = 11
    Width = 87
    Height = 57
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      'Select Quote_Reason.*'
      'From Quote_Reason'
      'Where (Quote_Reason_Description Like :Code_From) and'
