object PBLUSICCodeFrm: TPBLUSICCodeFrm
  Left = 516
  Top = 190
  BorderStyle = bsDialog
  Caption = 'Look-Up A SIC Code'
  ClientHeight = 402
  ClientWidth = 485
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'SIC_Code_ID'
        Title.Caption = 'SIC Code'
        Width = 59
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'SIC_Code_Description'
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active SIC Codes'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'FROM SIC_Code'
        ...
        'WHERE ((SIC_Code_ID LIKE :SIC_Code_ID) or (SIC_Code_Description ' +
        'LIKE :SIC_Code_ID)) AND'
      
        '((Inactive = '#39'N'#39') or (Inactive is NULL) or (Inactive = :Inactive' +
        '))'
      'ORDER BY SIC_Code_ID')
    Left = 72
    Top = 24
    ParamData = <
      item
