object PBLUNonConformTypeFrm: TPBLUNonConformTypeFrm
  Left = 215
  Top = 128
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Non_Conform_Type_Descr'
        Title.Caption = 'Non Conformance Error Type'
        Width = 284
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where Non_Conform_Type_Descr LIKE :Code_From and'
