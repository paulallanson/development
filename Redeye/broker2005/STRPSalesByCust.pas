...
type
  TSTRPSalesByCustFrm = class(TForm)
    ...
    QRShape2: TQRShape;
    qrlblTitle: TgtQRLabel;
    qrlblDateRange: TgtQRLabel;
    PsQRLabel1: TgtQRLabel;
    PsQRLabel4: TgtQRLabel;
    PsQRLabel10: TgtQRLabel;
    PsQRLabel3: TgtQRLabel;
    PsQRLabel2: TgtQRLabel;
    PsQRLabel5: TgtQRLabel;
    qrlblGoodsValue: TgtQRLabel;
    qrlblGoodsTotal: TgtQRLabel;
    qrbGroupFooter: TQRBand;
    PsQRLabel8: TgtQRLabel;
    qrbRepTotal: TQRBand;
    PsQRLabel9: TgtQRLabel;
    psqrlblCustTotal: TgtQRLabel;
    psqrlblSalesTotal: TgtQRLabel;
    PsQRShape2: TgtQRShape;
    PsQRShape3: TgtQRShape;
    PsQRLabel12: TgtQRLabel;
    PsQRLabel13: TgtQRLabel;
    qrlblDelivery: TgtQRLabel;
    PsQRShape4: TgtQRShape;
    QRSubDetail1: TQRSubDetail;
    PsQRDBText11: TgtQRDBText;
    PsQRDBText10: TgtQRDBText;
    PsQRDBText2: TgtQRDBText;
    PsQRDBText3: TgtQRDBText;
    PsQRDBText8: TgtQRDBText;
    qrlblBoxes: TQRLabel;
    PsQRDBText4: TgtQRDBText;
    PsQRDBText13: TgtQRDBText;
    qrdbGoodsValue: TgtQRDBText;
    qrdbGoodsTotal: TgtQRDBText;
    ...
    PsQRLabel6: TgtQRLabel;
    qrdbRepName: TQRDBText;
    PsQRLabel7: TgtQRLabel;
    psqrlblRepTotal: TgtQRLabel;
    PsQRShape1: TgtQRShape;
    PsQRLabel11: TgtQRLabel;
    qrDelToFooter: TQRBand;
    qrlblDelTo: TQRLabel;
    PsQRShape5: TgtQRShape;
    PsQRShape6: TgtQRShape;
    PsQRLabel14: TgtQRLabel;
    psqrlblCust2Total: TgtQRLabel;
