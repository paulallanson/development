...
type
  TStMaintAgedStkFrm = class(TForm)
    ...
    qrySelUnPaidAgedStkPart: TWideStringField;
    qrySelUnPaidAgedStkDescription: TWideStringField;
    qrySelUnPaidAgedStkSales_Value: TCurrencyField;
    qrySelUnPaidAgedStkSell_Pack_Size: TIntegerField;
    qrySelUnPaidAgedStkPart_Store_Name: TWideStringField;
    qrySelUnPaidAgedStkNot_In_Use: TWideStringField;
    qrySelUnPaidAgedStkCustName: TWideStringField;
    qrySelUnPaidAgedStkBin: TWideStringField;
    qrySelUnPaidAgedStkLot: TWideStringField;
    qrySelUnPaidAgedStkStock_Ref: TWideStringField;
