object PBMaintFormReferencefrm: TPBMaintFormReferencefrm
  Left = 178
  Top = 122
  ...
  object DetsGrpBox: TGroupBox
    ...
    object btnStockSelection: TBitBtn
      Left = 356
      Top = 93
      Width = 25
      Height = 23
      Hint = 'Stock code selection'
      Caption = '...'
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      ...
      ShowHint = True
      TabOrder = 8
      OnClick = btnStockSelectionClick
    end
  end
  ...
  object qryCheckFormRef5: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      ...
      'customer_branch.name as branch_name'
        ...
        'from part left join customer on (part.customer = customer.custom' +
        'er)'
      
        '  left join customer_branch on ((part.customer = customer_branch' +
        '.customer) and (part.branch_no = customer_branch.branch_no))'
