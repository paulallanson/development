...
type
  TPBLURevenueLocFrm = class(TForm)
    ...
    GetDetsSQLInvoice_Location_Descr: TWideStringField;
    GetDetsSQLDefault_PM_Revenue_Centre: TWideStringField;
    GetDetsSQLDefault_Description: TWideStringField;
    GetDetsSQLinactive: TWideStringField;
    GetDetsSQLColor: TIntegerField;
    GetDetsSQLFont_Color: TIntegerField;
    GetDetsSQLLogo_Path: TWideStringField;
    GetDetsSQLRegistered_Address: TWideStringField;
