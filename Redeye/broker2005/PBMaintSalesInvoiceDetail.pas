...
type
  TPBMaintSalesInvoiceDetailFrm = class(TForm)
    ...
    qrySIAllDetailspart: TWideStringField;
    ...
    qrySIAllDetailscust_order_no: TWideStringField;
    ...
    qrySIAllDetailspart_description: TWideStringField;
    qrySIAllDetailsPart_Cost_Cat: TCurrencyField;
    qrySIAllDetailsCustomer_Name: TWideStringField;
    qrySIAllDetailsBranch_Name: TWideStringField;
    qrySIAllDetailsShort_Code: TWideStringField;
    qrySIAllDetailsOrderedBy: TWideStringField;
    qrySIAllDetailsDeliveryCustName: TWideStringField;
    qrySIAllDetailsDeliveryBranchName: TWideStringField;
    qrySIAllDetailsdate_required: TDateTimeField;
    qrySIAllDetailsDelivery_Date: TDateTimeField;
    qrySIAllDetailscost_centre: TWideStringField;
    qrySIAllDetailsVat_Rate: TFloatField;
    qrySIAllDetailsDeliveryLocation: TWideStringField;
    qryAdhoc: TFDQuery;
