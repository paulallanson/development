...
type
  TPBRPSalesByInvDetFrm = class(TForm)
    ...
    oldqrySalesByInvAccount_Code: TWideStringField;
    oldqrySalesByInvName: TWideStringField;
    oldqrySalesByInvCustomers_Desc: TWideStringField;
    oldqrySalesByInvSales_Invoice_no: TWideStringField;
    ...
    oldqrySalesByInvSupplier_Name: TWideStringField;
    oldqrySalesByInvRep_Name: TWideStringField;
    oldqrySalesByInvSupplier_Job_Ref: TWideStringField;
    oldqrySalesByInvPOLine: TWideStringField;
    ...
    oldqrySalesByInvInvoiceRef: TWideStringField;
