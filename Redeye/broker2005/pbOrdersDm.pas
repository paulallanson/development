...
type
  TdtmdlOrders = class(TDataModule)
    ...
    qryCallOffsOrder_date: TDateTimeField;
    qryCallOffscust_order_no: TStringField;
    qryCallOffsGoods_Required: TDateTimeField;
    qryCallOffsOrder_Type: TStringField;
    qryCallOffsOrder_status: TIntegerField;
    qryCallOffsStatus_Description: TStringField;
    qryCallOffsBranch_Name: TStringField;
    ...
    qryCallOffsOrder_Price: TFloatField;
