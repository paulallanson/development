object PBLUPreProductionFrm: TPBLUPreProductionFrm
  Left = 215
  Top = 128
  BorderStyle = bsDialog
  Caption = 'Look-Up Pre Production Process'
  ClientHeight = 299
  ClientWidth = 450
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Pre_Production_Process_Desc'
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Pre_Production_Process'
        ...
        'Where (Pre_Production_Process.Pre_Production_Process_Desc Like :' +
        'Code_From)'
      'Order By Pre_Production_Process.Pre_Production_Process_Desc'
      ' ')
    Left = 24
    Top = 24
    ParamData = <
