...
type
  TPBRSRptOrdsFrm = class(TForm)
    ...
    qryLivecust_order_no: TStringField;
    qryLivecustomer: TIntegerField;
    qryLivebranch_no: TIntegerField;
    qryLivecustomers_desc: TStringField;
    qryLiveQuantity: TFloatField;
    qryLiveselling_price: TCurrencyField;
    qryLivesell_unit: TStringField;
    qryLiveorder_price: TCurrencyField;
    qryLiveorder_unit: TStringField;
    qryLiveoriginal_order: TFloatField;
    qryLiverepName: TStringField;
    qryLiveCustName: TStringField;
    qryLiveexpDate: TDateTimeField;
    qryLiveexpLife: TDateTimeField;
    qryLiveForm_Reference_ID: TStringField;
    qryLiveForm_Reference_Descr: TStringField;
    ...
    qryLiveStatus_Description: TStringField;
