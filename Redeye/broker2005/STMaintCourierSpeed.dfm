object STMaintCourierSpeedFrm: TSTMaintCourierSpeedFrm
  Left = 225
  Top = 152
  ...
  object DetsGrpBox: TGroupBox
    ...
    object chkbxActive: TCheckBox
      ...
      Width = 185
      Height = 17
      Caption = 'Courier Speed type is active'
      TabOrder = 1
    end
  ...
  object AddSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Insert Into Courier_Speed'
      '        (Courier_Speed,'
      '        Speed_Description)'
      'Select Max(Courier_Speed)+1, :GUID'
      'From Courier_Speed'
      ' ')
    Left = 280
    Top = 16
  ...
  object UpdSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Update Courier_Speed'
      'Set     Speed_Description = :Speed_Description,'
      '        Inactive = :inactive,'
      '        Courier = :Courier'
      'Where'
