...
type
  TPBRPCustContDetFrm = class(TForm)
    ...
    GetDetsQryEmail: TStringField;
    GetDetsQryContact_Phone: TStringField;
    GetDetsQryMobile_No: TStringField;
    ...
    GetDetsQryContact_Status_Descr: TStringField;
    GetDetsQryBuilding_No_name: TStringField;
    GetDetsQryStreet: TStringField;
    GetDetsQryLocale: TStringField;
    GetDetsQryTown: TStringField;
    ...
    GetDetsQryAcc_Active: TStringField;
    GetDetsQryPhone: TStringField;
    GetDetsQryContact_Level_Description: TStringField;
