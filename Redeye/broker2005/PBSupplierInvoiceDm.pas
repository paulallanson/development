...
type
  ...
  TdmSupplierInvoice = class(TDataModule)
    ...
    qrySIHeaderGridSupplier_Invoice_no: TStringField;
    qrySIHeaderGridSupp_Invoice_Status: TIntegerField;
    qrySIHeaderGridCurrency_Code: TIntegerField;
    qrySIHeaderGridSupp_Inv_Alt_Ref: TStringField;
    qrySIHeaderGridSupplier_Name: TStringField;
    ...
    qryPOAllLinesSupp_Inv_Recd: TStringField;
    qryPOAllLinesSupplier_Name: TStringField;
    qryPOAllLinesBranch_Name: TStringField;
    qryPOAllLinesStatus_Description: TStringField;
    ...
    qryPOAllLinesCustomer_Name: TStringField;
    ...
    qryPCHeaderGridInvoice_or_Credit: TStringField;
    ...
    qryPOsSalesInvdSuppliers_Desc: TStringField;
    ...
    qryPOsSalesInvdSupp_Inv_Recd: TStringField;
    qryPOsSalesInvdSupplier_Name: TStringField;
    qryPOsSalesInvdBranch_Name: TStringField;
    qryPOsSalesInvdStatus_Description: TStringField;
    ...
    qryPOsSalesInvdPrice_Unit_Description: TStringField;
    ...
    qryPOsDelivSuppliers_Desc: TStringField;
    ...
    qryPOsDelivSupp_Inv_Recd: TStringField;
    qryPOsDelivSupplier_Name: TStringField;
    qryPOsDelivBranch_Name: TStringField;
    qryPOsDelivStatus_Description: TStringField;
    qryPOsDelivVat_Rate: TFloatField;
    qryPOsDelivSupplier_Vat_Code: TIntegerField;
    qryPOsDelivCurrency_Code: TIntegerField;
    qryPOsDelivPrice_Unit_Description: TStringField;
    qryPOsDelivPrice_Unit_Factor: TFloatField;
    qryPOsDelivCustomer_Name: TStringField;
    qryPOsDelivPOLine: TStringField;
    ...
    qryPOAllLinesSales_Invoice_no: TStringField;
    qryPOAllLinesInvoice_Date: TDateTimeField;
    qryPOsSalesInvdSales_Invoice_No: TStringField;
    ...
    qrySIHeaderGridNew_Date: TStringField;
    qryPCHeaderGridDate_Created: TDateTimeField;
    qryPCHeaderGridNew_Date: TStringField;
    qryPOAllLinesCust_Order_No: TStringField;
    qryPOsSalesInvdCust_Order_No: TStringField;
    qryPOsDelivCust_Order_No: TStringField;
