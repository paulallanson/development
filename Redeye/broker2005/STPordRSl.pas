...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, DBCtrls, DB, DBTables, STPOrdRep, gtQrExport,
  Inifiles;
...
begin
  ...
  sFileName := 'PO' + trim(selectionMemo.text);
  ...
  if sAttachmentType = 'RTF' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
        STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(RTFFilter);
      finally
        STPOrdRepFrm.PurchOrdQuickReport.QRPrinter.Free;
        STPOrdRepFrm.PurchOrdQuickReport.QRPrinter := nil;
        RTFFilter.Free;
      end;
    end
  else
  if sAttachmentType = 'HTML' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
        STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(HTMLFilter);
  ...
  if sAttachmentType = 'PDF' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
        STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(PDFFilter);
      finally
        STPOrdRepFrm.PurchOrdQuickReport.QRPrinter.Free;
        STPOrdRepFrm.PurchOrdQuickReport.QRPrinter := nil;
        PDFFilter.Free;
  ...
  if sAttachmentType = 'GIF' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
        STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(GIFFilter);
  ...
  if sAttachmentType = 'JPEG' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
        STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(JPEGFilter);
  ...
  if sAttachmentType = 'BMP' then
    begin
      ...
      try
        STPOrdRepFrm.PurchOrdQuickReport.Prepare;
 //       ExportToRTF(STPOrdRepFrm.PurchOrdQuickReport, sLocation + sFilename + '.bmp');
      STPOrdRepFrm.PurchOrdQuickReport.ExportToFilter(BMPFilter);
