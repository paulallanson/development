object STLUPrtGrpFrm: TSTLUPrtGrpFrm
  Left = 186
  Top = 152
  Caption = 'Look-Up A Product Group'
  ClientHeight = 314
  ClientWidth = 437
  Color = clBtnFace
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Part_Group'
      'Where (Part_Group.Part_Group_Descr Like :Code_From)'
      'Order By Part_Group.Part_Group_Descr'
      ' ')
    Left = 64
    Top = 64
    ParamData = <
