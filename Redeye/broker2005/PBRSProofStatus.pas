...
type
  TPBRSProofStatusFrm = class(TForm)
    ...
    qryCurrentProofStatusProof_Status: TWideStringField;
    qryCurrentProofStatusCustomers_Desc: TWideStringField;
    qryCurrentProofStatusCustomer: TIntegerField;
    qryCurrentProofStatusBranch_no: TIntegerField;
    qryCurrentProofStatusCustomer_Name: TWideStringField;
    qryCurrentProofStatusGoods_Required: TDateTimeField;
    qryCurrentProofStatusSupplier: TIntegerField;
    qryCurrentProofStatusSupplier_Name: TWideStringField;
    qryCurrentProofStatusCust_Order_No: TWideStringField;
    qryCurrentProofStatusPurch_Ord_Line_Status: TIntegerField;
    qryCurrentProofStatusDescription: TWideStringField;
    ...
    qryCurrentProofStatusPOLine: TWideStringField;
