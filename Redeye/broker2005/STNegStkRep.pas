...
type
  TSTNegStkRepFrm = class(TForm)
    ...
    GetDetsQueryPart: TWideStringField;
    GetDetsQueryPart_Store_Lot: TWideStringField;
    GetDetsQueryPart_Store: TIntegerField;
    GetDetsQueryPart_Bin: TWideStringField;
    GetDetsQueryStock_Pack_Quantity: TIntegerField;
    GetDetsQueryPart_Description: TWideStringField;
    GetDetsQueryPurch_Pack_Quantity: TIntegerField;
    GetDetsQueryPart_Purchase_Price: TCurrencyField;
    GetDetsQueryPart_Store_Name: TWideStringField;
    ...
    QRLabel1: TQRLabel;
    QRLblInUse: TQRLabel;
    GetDetsQueryNot_In_Use: TWideStringField;
    QRLblSel: TQRLabel;
