...
type
  TPBRPOSSInvPaymentsFrm = class(TForm)
    ...
    qrySalesInvOutPayCustomer_Name: TStringField;
    qrySalesInvOutPaySales_invoice: TIntegerField;
    qrySalesInvOutPaySales_invoice_no: TStringField;
    ...
    qrySalesInvOutPayPaid_Status: TStringField;
    qrySalesInvOutPayPaid_Amount: TCurrencyField;
    qrySalesInvOutPayAccount_Number: TStringField;
    qrySalesInvOutPayContact_Name: TStringField;
    qrySalesInvOutPayReference: TStringField;
    qrySalesInvOutPayExpiry_date: TStringField;
    ...
    QRLabel19: TQRLabel;
    QRDBText4: TQRDBText;
    qrySalesInvOutPayPayment_Method_Desc: TStringField;
...
begin
  ...
  QckRpSalesInvPay.PrinterSettings.PrinterIndex := Printer.PrinterIndex;
