...
type
  TdtmdlDeliveries = class(TDataModule)
    ...
    qryPODetailsDelivery_Instructions: TWideStringField;
    qryPODetailsDeliver_via_Company: TWideStringField;
    qryPODetailsDate_Deliv_Actual: TDateTimeField;
    qryPODetailsDelivery_to_Stock: TWideStringField;
    qryPODetailsDelivery_note_printed: TWideStringField;
    qryPODetailsSuppliers_Desc: TWideStringField;
    qryPODetailsOrder_Customer: TIntegerField;
    qryPODetailsCustomer_Branch: TIntegerField;
    qryPODetailsForms_Per_Box: TWideStringField;
    qryPODetailsNo_of_Sets: TWideStringField;
    qryPODetailsCust_order_no: TWideStringField;
    ...
    qryPODetailsSupplier_Name: TWideStringField;
    qryPODetailsCustomer_Name: TWideStringField;
    qryPODetailsOrder_Status: TWideStringField;
    qryPODetailsForm_Reference: TIntegerField;
    qryPODetailsOriginal_Order: TFloatField;
    qryPODetailsOriginal_OrderLine: TFloatField;
    qryPODetailsNumber_Instructions: TWideStringField;
    dtsDetails: TDataSource;
    qrySODetails: TFDQuery;
    qryPODetailsDeliveryName: TWideStringField;
    ...
    qrySODetailsReplenish_ID: TWideStringField;
    qrySODetailsReplenish_Source_Descr: TWideStringField;
    ...
    qryPODetailsInvoice_upfront: TWideStringField;
    qryPODetailsOrder_Price: TCurrencyField;
    qryPODetailsOrder_Unit: TIntegerField;
    qryPODetailsPrice_unit_description: TWideStringField;
    ...
    qrySODetailsConsignment_number: TWideStringField;
    qrySODetailsCourier: TIntegerField;
    qrySODetailsService_no: TIntegerField;
    qrySODetailsConfirm_Filename: TWideStringField;
    qrySODetailsConfirm_Filename_no: TIntegerField;
    qrySODetailsBranch_Name: TWideStringField;
    qryPODetailsContact_Name: TWideStringField;
    qryPODetailsorder_contact_name: TWideStringField;
    qryPODetailsReady_to_Invoice: TWideStringField;
