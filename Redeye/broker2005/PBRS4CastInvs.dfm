object PBRS4CastInvsFrm: TPBRS4CastInvsFrm
  Left = 186
  Top = 137
  ...
  object chkbxShowzero: TCheckBox
    Left = 205
    Top = 190
    Width = 244
    Height = 17
    Caption = 'Show zero value orders'
    TabOrder = 8
  end
  object chkbxShow2bInvoiced: TCheckBox
    Left = 205
    Top = 213
    Width = 276
    Height = 17
    Caption = 'Only show orders delivered but not invoiced'
    TabOrder = 9
  end
