object PBLUCustCstCntrFrm: TPBLUCustCstCntrFrm
  Left = 187
  Top = 151
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Customer_CostCentre'
        ...
        'Where ((Customer_CostCentre.Cost_Centre Like :Code_From) or (Cus' +
        'tomer_CostCentre.Description Like :Code_From)) and'
      '      Customer_CostCentre.Customer = :Customer'
      'Order By Customer_CostCentre.Cost_Centre'
      ''
      ''
      ' '
      ' '
