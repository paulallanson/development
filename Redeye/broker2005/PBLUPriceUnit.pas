...
VSS Info:
$Header: /PBL D5/PBLUPriceUnit.pas 10    20/06/03 9:52 Andrewh $
$History: PBLUPriceUnit.pas $
 * 
 * *****************  Version 10  *****************
 ...
 * 
 * *****************  Version 7  *****************
 * User: Paul         Date: 13/09/:2   Time: 9:41
 * Updated in $/PBL D5
 * Changed so that the main price unit records, Price_unit = 1 and
 * Price_Unit = 2 can not be deleted or changed.
 * 
 * *****************  Version 6  *****************
