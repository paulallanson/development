object StMovSlfrm: TStMovSlfrm
  ...
  object GroupBox1: TGroupBox
    ...
    object PartFromEdit: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnExit = PartFromEditExit
    end
    object PartFromBitBtn: TBitBtn
      Left = 312
      Top = 16
      Width = 25
      Height = 25
    ...
    object PartToBtBtn: TBitBtn
      ...
      ParentFont = False
      TabOrder = 5
      OnClick = PartToBtBtnClick
    end
    object dblkpPartMoveType: TDBLookupComboBox
      Left = 100
      Top = 114
      Width = 201
      Height = 21
      ...
      ListSource = STStockDataMod.MoveTypesDataSource
      ParentFont = False
      TabOrder = 6
      OnClick = StoreDBLookupComboBoxClick
    end
