...
begin
  ...
  sFileName := 'SO' + inttostr(SONumber);
  ...
  if sAttachmentType = 'RTF' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
        STRPSordFrm.SalesOrdQuickReport.ExportToFilter(RTFFilter);
      finally
        STRPSordFrm.SalesOrdQuickReport.QRPrinter.Free;
        STRPSordFrm.SalesOrdQuickReport.QRPrinter := nil;
        RTFFilter.Free;
      end;
    end
  else
  if sAttachmentType = 'HTML' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
        STRPSordFrm.SalesOrdQuickReport.ExportToFilter(HTMLFilter);
  ...
  if sAttachmentType = 'PDF' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
        STRPSordFrm.SalesOrdQuickReport.ExportToFilter(PDFFilter);
      finally
        STRPSordFrm.SalesOrdQuickReport.QRPrinter.Free;
        STRPSordFrm.SalesOrdQuickReport.QRPrinter := nil;
        PDFFilter.Free;
  ...
  if sAttachmentType = 'GIF' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
        STRPSordFrm.SalesOrdQuickReport.ExportToFilter(GIFFilter);
  ...
  if sAttachmentType = 'JPEG' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
        STRPSordFrm.SalesOrdQuickReport.ExportToFilter(JPEGFilter);
  ...
  if sAttachmentType = 'BMP' then
    begin
      ...
      try
        STRPSordFrm.SalesOrdQuickReport.Prepare;
 //       ExportToRTF(STRPSordFrm.SalesOrdQuickReport, sLocation + sFilename + '.bmp');
      STRPSordFrm.SalesOrdQuickReport.ExportToFilter(BMPFilter);
