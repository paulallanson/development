...
type
  TPBRSSuppDetFrm = class(TForm)
    ...
    qryCurrentSuppStatusName: TWideStringField;
    qryCurrentSuppStatusBuilding_No_name: TWideStringField;
    qryCurrentSuppStatusStreet: TWideStringField;
    qryCurrentSuppStatusLocale: TWideStringField;
    qryCurrentSuppStatusTown: TWideStringField;
    qryCurrentSuppStatusPostcode: TWideStringField;
    qryCurrentSuppStatusPhone: TWideStringField;
    qryCurrentSuppStatusFax_Number: TWideStringField;
    qryCurrentSuppStatusEmail: TWideStringField;
    qryCurrentSuppStatusNarrative: TIntegerField;
    qryCurrentSuppStatusAccount_Code: TWideStringField;
    qryCurrentSuppStatusAccount_Code_On_Ledger: TWideStringField;
    qryCurrentSuppStatusSupp_name: TWideStringField;
    qryCurrentSuppStatusName_1: TWideStringField;
