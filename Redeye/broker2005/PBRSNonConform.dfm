object frmPBRSNonConform: TfrmPBRSNonConform
  Left = 416
  Top = 188
  BorderStyle = bsDialog
  Caption = 'Print Non Conformance Advice'
  ClientHeight = 194
  ClientWidth = 418
  Color = clBtnFace
  ...
  object qryGetNCA: TFDQuery
    ...
    SQL.Strings = (
      ...
      '      INNER JOIN (Customer'
      '      INNER JOIN (Job_Bag'
      '      INNER JOIN Job_Bag_Non_Conform ON'
      '        Job_Bag.Job_Bag = Job_Bag_Non_Conform.Job_Bag) ON'
      '        Customer.Customer = Job_Bag.Customer) ON'
      '        Int_Sel.Sel1 = Job_Bag_Non_Conform.Job_Bag_Non_Conform'
