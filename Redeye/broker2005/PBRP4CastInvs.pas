...
type
  TPBRP4CastInvsFrm = class(TForm)
    ...
    qry4CastInvsdelivery_to_stock: TStringField;
    qry4CastInvsinvoice_upfront: TStringField;
    qry4CastInvsinactive: TStringField;
    qry4CastInvsorder_price: TCurrencyField;
    qry4CastInvsselling_price: TCurrencyField;
    qry4CastInvscust_order_no: TStringField;
    qry4CastInvscustomers_desc: TStringField;
    qry4CastInvsorder_date: TDateTimeField;
    qry4CastInvssell_unit_factor: TFloatField;
    qry4CastInvsorder_unit_factor: TFloatField;
    qry4CastInvscust_name: TStringField;
    qry4CastInvsrep: TIntegerField;
    qry4CastInvsrep_name: TStringField;
    qry4CastInvsform_reference_descr: TStringField;
    QRLabel11: TQRLabel;
    QRLabel9: TQRLabel;
    QRLabel12: TQRLabel;
