...
type
  TfrmPBRPQuote = class(TForm)
    ...
    qryReportlinesQuote_Line_description: TWideStringField;
    ...
    qryReportlinesLine_Converted: TWideStringField;
    ...
    qryReportlinesCosting_Tool_Flag: TWideStringField;
    ...
    qryReportlinesPrice_unit_Description: TWideStringField;
    qryReportlinesProduct_Type_Description: TWideStringField;
    ...
    qryReportSupplyLine_Converted: TWideStringField;
    qryReportSupplyQuantity: TFloatField;
    qryReportSupplyQuote_Supply_Description: TWideStringField;
    ...
    qryReportSupplyPrice_Unit_Description: TWideStringField;
    qryReportSupplyForm_Description: TWideStringField;
    SpecMemo: TQRMemo;
