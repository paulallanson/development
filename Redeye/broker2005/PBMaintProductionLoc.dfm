object PBMaintProductionLocFrm: TPBMaintProductionLocFrm
  Left = 206
  Top = 155
  ...
  object DetsGrpBox: TGroupBox
    ...
    object chkbxForwardStock: TCheckBox
      Left = 16
      Top = 176
      Width = 137
      Height = 17
      Caption = 'Receive Forward Stock'
      TabOrder = 11
    end
  end
  ...
  object GetLastSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'SELECT Production_Location FROM Production_Location'
      'WHERE Production_Location_Name = :GUID')
    Left = 152
    Top = 32
    ParamData = <
      item
  ...
  object AddSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Insert Into Production_Location'
      '  (Production_Location,'
  ...
  object UpdSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Part_Bin = :Part_Bin,'
      '        Receive_Forward_Stock = :Receive_Forward_Stock'
      'Where'
