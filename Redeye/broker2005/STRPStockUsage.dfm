object STRPStockUsagefrm: TSTRPStockUsagefrm
  Left = 25
  Top = 103
  Width = 1294
  Height = 623
  ...
  object qrpDetails: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object qrlblTitle: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Stock Usage Summary Report'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  object qryReport: TQuery
    ...
    SQL.Strings = (
      ...
      #9'ISNULL((select sum(Store_quantity)'
      #9' from part_movement'
      #9' where part_movement.part = part.part and'
        ...
        ','
      #9'ISNULL((select sum(Store_quantity*-1)'
      #9' from part_movement'
      #9' where part_movement.part = part.part and'
      ...
      '        Part_Store_Levels.Part_Store_type = 1'
      ''
      ''
      ' '
      ' '
