object PBLUPackageSizeFrm: TPBLUPackageSizeFrm
  Left = 147
  Top = 100
  BorderStyle = bsDialog
  Caption = 'Look-up a Package Size'
  ClientHeight = 317
  ClientWidth = 431
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Package_Size_Description'
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active package sizes'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Package_Size'
        ...
        'Where (Package_Size.Package_Size_Description Like :Code_From) AN' +
        'D'
      
        '((Package_Size.Inactive = '#39'N'#39') or (Package_Size.Inactive is NULL' +
        ') or (Package_Size.Inactive = :Inactive))'
      'Order By Package_Size.Package_Size_Description')
    Left = 24
    Top = 24
    ParamData = <
      item
