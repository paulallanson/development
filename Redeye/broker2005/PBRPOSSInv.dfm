object PBRPOSSInvFrm: TPBRPOSSInvFrm
  Left = 2
  Top = 115
  ...
  object qrReport: TQuickRep
    ...
    object qrbndPageHeader: TQRBand
      ...
      object qrlblTitle: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = 'Oustanding Invoicing Report - Run Date '
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
    ...
    object QRChildBandStk: TQRChildBand
      Left = 38
      Top = 214
      Width = 1047
      Height = 20
      ...
      object QRLblQtyToInv2: TQRLabel
        Left = 656
        Top = 0
        Width = 64
        Height = 17
      ...
      object QRlblSalesValue2: TQRLabel
        Left = 958
        Top = 0
        Width = 76
        Height = 17
  ...
  object qryDummy: TFDQuery
    SQL.Strings = (
      ...
      '      ((Purchase_OrderLine.Invoice_upfront)='#39'Y'#39')) OR'
        ...
        'se_OrderLine.Purch_Ord_Line_Status < 30))'
