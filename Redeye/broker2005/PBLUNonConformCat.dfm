object PBLUNonConformCatFrm: TPBLUNonConformCatFrm
  Left = 215
  Top = 128
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Non_Conform_Category_Descr'
        Title.Caption = 'Non Conformance Category'
        Width = 284
        Visible = True
      end>
  end
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active categories'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where Non_Conform_Category_Descr LIKE :Code_From AND'
