object PBLUProcessGroupFrm: TPBLUProcessGroupFrm
  Left = 215
  Top = 128
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM Process_Group'
      'WHERE Process_Group_description like :Code_From'
      'ORDER BY Process_Group.Process_Group_Description'
      ' ')
    Left = 24
    Top = 24
    ParamData = <
