object PBMaintNonConformDeptFrm: TPBMaintNonConformDeptFrm
  Left = 225
  Top = 152
  ...
  object GetLastSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select Non_Conform_Dept.*'
      'From Non_Conform_Dept'
      'Where Non_Conform_Dept_Descr = :GUID')
    Left = 88
    Top = 8
    ParamData = <
      item
  ...
  object AddSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Insert Into Non_Conform_Dept'
      '        (Non_Conform_Dept,'
      '        Non_Conform_Dept_Descr)'
      'Select Max(Non_Conform_Dept)+1, :GUID'
      'From Non_Conform_Dept')
    Left = 264
    Top = 8
    ParamData = <
  ...
  object UpdSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Update Non_Conform_Dept'
      
        'Set Non_Conform_Dept_Descr = :Non_Conform_Dept_Descr, inactive =' +
        ' :inactive'
      'Where (Non_Conform_Dept = :Non_Conform_Dept) '
      ''
      ' ')
    Left = 208
    Top = 8
  ...
  object qryZero: TFDQuery
    ...
    SQL.Strings = (
      'Update Non_Conform_Dept'
      'Set     Non_Conform_Dept_Descr = :Description'
      'Where'
      '(Non_Conform_Dept = :Non_Conform_Dept) '
      '')
    Left = 152
