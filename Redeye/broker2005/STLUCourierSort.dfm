object STLUCourierSortFrm: TSTLUCourierSortFrm
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Sort_Description'
        Title.Caption = 'Sort Type'
        Width = 284
        Visible = True
      end>
  end
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active sort types'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      'Select  Courier_Sort.*'
      'From Courier_Sort'
      'Where (Courier_Sort.Sort_Description Like :Code_From) and'
      '(Courier_Sort.Courier = :Courier) and'
      
        '((Courier_Sort.Inactive = '#39'N'#39') or (Courier_Sort.Inactive is NULL' +
        ') or (Courier_Sort.Inactive = :Inactive))'
      'Order By Courier_Sort.Sort_Description'
      ' ')
    Left = 144
    Top = 24
    ParamData = <
