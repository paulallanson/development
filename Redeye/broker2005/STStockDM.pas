...
type
  TSTStockDataMod = class(TDataModule)
    ...
    GetMoveTypeSQL: TFDQuery;
    GetStoreSQL: TFDQuery;
    GetFreeStoreStockSQL: TFDQuery;
    AddAllocSQL: TFDQuery;
    GetNextAllocSQL: TFDQuery;
    GetStoreStockIntSQL: TFDQuery;
    GetAllocStockByRefSQL: TFDQuery;
    UpdAllocSQL: TFDQuery;
    DelAllocSQL: TFDQuery;
    AddTransferSQL: TFDQuery;
    NextTransfer: TFDQuery;
    UpdSOAllocSQL: TFDQuery;
    GetStoreStockSQL: TFDQuery;
    GetStoreBinSQL: TFDQuery;
    AddStoreBinSQL: TFDQuery;
    GetDefPartStoreSQL: TFDQuery;
    GetLastIntSelSQL: TFDQuery;
    AddWorkSQL: TFDQuery;
    DelWorkSQL: TFDQuery;
    UpdSalesOrderAllocSQL: TFDQuery;
    GetPriceUnitSQL: TFDQuery;
    dtSrcPriceUnit: TDataSource;
    AddStoreStockSQL: TFDQuery;
    GetCouriersSQL: TFDQuery;
    CouriersDataSource: TDataSource;
    DelStockSNSQL: TFDQuery;
    GetStkSerialSQL: TFDQuery;
    ResetStockSNSQl: TFDQuery;
    qryUpdStockBin: TFDQuery;
    GetSalesOrderLineSQL: TFDQuery;
    qryGetTransferStStk: TFDQuery;
    qryGetNonTransferStStk: TFDQuery;
    qryGetStoreStock: TFDQuery;
    qryGetJobBagRtn: TFDQuery;
    qryAddJobBagRtn: TFDQuery;
    qryGetReturns: TFDQuery;
    qryPartInactive: TFDQuery;
    GetAllocStockbyStoreStockSQL: TFDQuery;
    ...
    qryGetPart: TFDQuery;
    qryAddJobBagRequest: TFDQuery;
    qryGetSalesOrderLines: TFDQuery;
    qryUpdSOStatus: TFDQuery;
    qryGetNextPickNo: TFDQuery;
    qryGetSOAlloc: TFDQuery;
    qryAddSOPick: TFDQuery;
    qryAddSODelivNote: TFDQuery;
