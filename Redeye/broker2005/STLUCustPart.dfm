object STLUCustPartFrm: TSTLUCustPartFrm
  Left = 296
  Top = 99
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'Customer_Part_Code'
        Title.Caption = 'Customer Part Code'
        Width = 226
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Part_Customer, Customer, Part'
      'Where '
      '(Part_Customer.Part = :Part) and'
      '(Customer.Name Like :Code_From) and'
      '(Part_Customer.Part = Part.Part) and'
      '(Part_Customer.Customer = Customer.Customer)'
