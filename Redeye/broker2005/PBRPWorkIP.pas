...
type
  TPBRPWorkIPfrm = class(TForm)
    ...
    qryReportAccount_Manager: TWideStringField;
    ...
    qryReportStatus_Description: TWideStringField;
    qryReportExtra_Sales: TFloatField;
    qryReportExtra_Costs: TFloatField;
    qryReportProduct_Type_Description: TWideStringField;
    qryReportProduct_Type_Short_Desc: TWideStringField;
    qryReportProduct_Type_Sales_Nominal: TWideStringField;
