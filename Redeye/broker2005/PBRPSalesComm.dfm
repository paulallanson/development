object PBRPSalesCommFrm: TPBRPSalesCommFrm
  ...
  object oldqryGetJBCosts: TQuery
    DatabaseName = 'PB'
    SQL.Strings = (
  ...
  object qryGetPOSICharges: TQuery
    DatabaseName = 'PB'
    SQL.Strings = (
  ...
  object qryGetCallOffInvoices: TQuery
    DatabaseName = 'PB'
    SQL.Strings = (
