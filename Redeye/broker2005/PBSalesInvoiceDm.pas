...
type
  ...
  TdmSalesInvoice = class(TDataModule)
    ...
    qryJBUpLineStatus: TFDQuery;
    oldqryJBAll: TFDQuery;
    qryGetCust: TFDQuery;
    qrySOCheckJB: TFDQuery;
    qryInvoiceLoc: TFDQuery;
    dsInvoiceLoc: TDataSource;
    qryCheckJBPO: TFDQuery;
    qryGetInvoiceLoc: TFDQuery;
    qryGetDefaultInvLoc: TFDQuery;
    qryCustJBL: TFDQuery;
    dsCustJBL: TDataSource;
    qryGetCat: TFDQuery;
    qryGetJBInvLoc: TFDQuery;
    qryCreditReason: TFDQuery;
    dtsCreditReason: TDataSource;
    qrySIGetLastLine: TFDQuery;
    qryJBChkStockReq: TFDQuery;
    qryUpEInvoice: TFDQuery;
    qryJBHead: TFDQuery;
    qrySIUpStatus: TFDQuery;
    qryPOUpRep: TFDQuery;
    qryJBUpRep: TFDQuery;
    qrySODelRep: TFDQuery;
    qrySOUpRep: TFDQuery;
    qrySIAddDetail: TFDQuery;
    qrySIGetLastDetail: TFDQuery;
    qrySIAllDetails: TFDQuery;
    qrySOAllUninvoiced: TFDQuery;
    ...
    qryPriceUnits: TFDQuery;
    dtsPriceUnits: TDataSource;
    qrySOUpdDelQty: TFDQuery;
    qrySOUnDoLines: TFDQuery;
    qryUpPaidStatus: TFDQuery;
    qrySubRep: TFDQuery;
    dsSubRep: TDataSource;
    OldqrySIHeaderGrid: TFDQuery;
    ...
    qrySIHeaderGridPack_Format_Description: TWideStringField;
    qrySIHeaderGridEnclosing_Type: TWideStringField;
    ...
    qrySOAllCost_Centre: TWideStringField;
    qrySOAllCustomer0: TIntegerField;
    qrySOAllOrder_Type: TWideStringField;
    ...
    qrySOAllDelivery_Notes: TWideStringField;
    ...
    qrySCHeaderGridInv_to_Customer: TIntegerField;
    qrySCHeaderGridInv_to_Branch: TIntegerField;
    qrySCHeaderGridAccount_code: TWideStringField;
    qrySCHeaderGridGoods_Value: TCurrencyField;
