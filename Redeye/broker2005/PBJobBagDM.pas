...
uses
  ...
  Db, DBTables, pbMainMenu, PBWOrdersDm, CCSCommon;
...
type
  ...
  TdmJobBag = class(TDataModule)
    ...
    qryJBAllLinesJob_Bag_Line_Type: TStringField;
    ...
    qryJBAllLinesJob_Bag_Line_Descr: TStringField;
    qryJBAllLinesJob_Bag_Line_Cost: TCurrencyField;
    qryJBAllLinesJob_Bag_Line_Sell: TCurrencyField;
    qryJBAllLinesJob_Bag_Line_Invoiced: TStringField;
    qryJBAllLinesJob_Bag_Quantity: TIntegerField;
    qryJBAllLinesVAT_Code: TIntegerField;
    qryJBAllLinesCurrency_Code: TIntegerField;
    qryJBAllLinesMargin: TFloatField;
    qryJBType: TQuery;
    qryJBAllLinesTypeDesc: TStringField;
    qryJBAllLinesSupplierName: TStringField;
    qryJBAllLinesBranchName: TStringField;
    qryPriceUnit: TQuery;
    OperatorSQL: TQuery;
    ...
    qryJBDelLine: TQuery;
    dsDummy: TDataSource;
    qryJBAllLinessupp_inv_recd: TStringField;
    qryPO: TQuery;
    qryJBAllLinesInactive: TStringField;
    ...
    qrySO: TQuery;
    qryJBAllLinesOrderNumber: TStringField;
    ...
    qryGetAllJBLines: TQuery;
    qryGetAccountMgr: TQuery;
    GetLastJBSQL: TQuery;
    UpdLastJBSQL: TQuery;
    qrySpare: TQuery;
    qryJBAddHeader: TQuery;
    qryGetOpAccountTeam: TQuery;
    qryGetAccountTeam: TQuery;
    qryJBRepeatLines: TQuery;
    ...
    qryJBWO: TQuery;
    srcJBWO: TDataSource;
    qryJBUpdHeaderStatus: TQuery;
    GetPartDetailsSQL: TQuery;
    qryJBAllWorks: TQuery;
    qryJBAddWorks: TQuery;
    qryJBWorks: TQuery;
    qryGetSupplier: TQuery;
    qryGetWorksOrder: TQuery;
    qryCheckJBInvoiced: TQuery;
    qryJBAllLinesQty_Invoiced: TFloatField;
    qryJBAllLinesReady_to_Invoice: TStringField;
    qryInvoiceLoc: TQuery;
    srcInvoiceLoc: TDataSource;
    qrySalesInvoice: TQuery;
    qryPOHead: TQuery;
    qryJBDocument: TQuery;
    qryJBAddDocument: TQuery;
    qryJBAllDocuments: TQuery;
    qryAllSalesInvoices: TQuery;
    srcAllSalesInvoices: TDataSource;
    qrySITotal: TQuery;
    qryGetRep: TQuery;
    qryGetCustomerRep: TQuery;
    oldqryJBAllProcesses: TQuery;
    qryJBAddProcess: TQuery;
    oldqryJBProcess: TQuery;
    qryJBAllSchedules: TQuery;
    qryJBAddSchedule: TQuery;
    qryJBSchedule: TQuery;
    qryJBAllRequests: TQuery;
    qryJBRequest: TQuery;
    qryJBAddRequest: TQuery;
    qryAddSOJBLine: TQuery;
    qryAllPurchInvoices: TQuery;
    srcAllPurchInvoices: TDataSource;
    qryQHeader: TQuery;
    qryQAllLines: TQuery;
    qryJBAllLinesUnit_Cost: TCurrencyField;
    qryJBAllLinesUnit_SSP: TCurrencyField;
    qryJBAddSupply: TQuery;
    qryJBSupply: TQuery;
    qryJBAllSupplies: TQuery;
    qryQAllSupplies: TQuery;
    qryJBHeadTechXML: TQuery;
    qryJBProcessTechXML: TQuery;
    qryJBMasterTechXML: TQuery;
    qryGetJBProdStatus: TQuery;
    qryAllProcesses: TQuery;
    qryJBProcess: TQuery;
    qryJBAllLinesUnit_Cost_Plus_OHD: TCurrencyField;
    qryJBAllLinesUnit_SSP_Original: TCurrencyField;
    OldqryJBProcessTechXML: TQuery;
    qryJBSILines: TQuery;
    qryJBAllLinesLine_Inactive: TStringField;
    qryGetCustCC: TQuery;
    ...
    qryDataCollectWC_Operator_Name: TStringField;
    qryDataCollectProcess_Group: TIntegerField;
    qryDataCollectProcess_Group_Description: TStringField;
    qryDataCollectProcess: TIntegerField;
    qryDataCollectProcess_Description: TStringField;
    qryDataCollectWork_Centre: TIntegerField;
    qryDataCollectWork_Centre_Name: TStringField;
    qryDataCollectOperation: TIntegerField;
    qryDataCollectOperation_Description: TStringField;
    qryDataCollectPaper_Size: TIntegerField;
    qryDataCollectPaper_Size_Description: TStringField;
    qryDataCollectNumber_Up: TIntegerField;
    qryDataCollectQuantity: TFloatField;
    qryDataCollectLaser_Format: TStringField;
    ...
    qryGetDataCollectTotals: TQuery;
    ...
    qryJBUpdQuoteStatus: TQuery;
    qryGetCustomerPrices: TQuery;
    qryJBAllNonConforms: TQuery;
    qryGetLastNC: TQuery;
    qryUpdateLastNC: TQuery;
    qryJBAddNonConform: TQuery;
    qryGetNonConformStatus: TQuery;
    qryPITotal: TQuery;
    qryDataCollectCosts: TQuery;
    srcDataCollectCosts: TDataSource;
    qryJBAllLinesVat_Description: TStringField;
    qryJBDelivery: TQuery;
    qryJBAddDelivery: TQuery;
    qryJBAllDeliveries: TQuery;
    GetAddHocAddrSQL: TQuery;
    AddrSRC: TDataSource;
    GetRepAddrSQL: TQuery;
    GetCustAddrSQL: TQuery;
    GetSuppAddrSQL: TQuery;
    GetCompAddrSQL: TQuery;
    GetCompBrAddrSQL: TQuery;
    qryCourierService: TQuery;
    dtsCourierService: TDataSource;
    qryPackageType: TQuery;
    dtsPackageType: TDataSource;
    qryAllPriceUnits: TQuery;
    dtsAllPriceUnits: TDataSource;
    qryGetCustomerAccount: TQuery;
    qryGetProcessGroups: TQuery;
    qryJProcessGroup: TQuery;
    qryJAddProcessGroup: TQuery;
    qryQProcessGroup: TQuery;
    qryAllSalesInvoiceCharges: TQuery;
    qryAllSalesInvoicesSales_Invoice: TIntegerField;
    qryAllSalesInvoicesSales_Invoice_No: TStringField;
    qryAllSalesInvoicesInvoice_Date: TDateTimeField;
    qryAllSalesInvoicesInvoice_Description: TStringField;
    qryAllSalesInvoicesInvoice_or_Credit: TStringField;
    ...
    qryAllPurchInvoiceCharges: TQuery;
    qryAllPurchInvoicesSupplier_Name: TStringField;
    qryAllPurchInvoicesSupplier_Invoice: TIntegerField;
    qryAllPurchInvoicesSupplier_Invoice_no: TStringField;
    qryAllPurchInvoicesInvoice_Date: TDateTimeField;
    qryAllPurchInvoicesSupp_Inv_Alt_Ref: TStringField;
    qryAllPurchInvoicesInvoice_or_Credit: TStringField;
    ...
    qryJBAllLinesLine_Is_Internal_Cost: TStringField;
    qryJBAllLinesJob_Cost_Markup_Perc: TFloatField;
    qryJBRepeatLinesLine_Is_Internal_Cost: TStringField;
    qryJBRepeatLinesJob_Cost_Markup_Perc: TFloatField;
    qryJBRepeatLinesUnit_Cost: TFloatField;
    qryJBRepeatLinesUnit_SSP: TFloatField;
    qryJBRepeatLinesUnit_Cost_Plus_OHD: TFloatField;
    qryJBRepeatLinesUnit_SSP_Original: TFloatField;
    qryGetCustomerSubRep: TQuery;
    qryGetCustomer: TQuery;
    qryJBAllLinesReseller_Price: TFloatField;
    qryJBAllLinesJob_Bag_Line_Reseller: TFloatField;
    qryPackFormat: TQuery;
