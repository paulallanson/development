...
//  sFileName := 'ENQ' + inttostr(FEnquiry);
  ...
  {Format is 'OverdueEnqs' + Random Number}
  sFilename := 'OverdueEnqs' + '-' + sFilename;
  ...
  if sAttachmentType = 'RTF' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(RTFFilter);
      finally
        PBRPODueEnqFrm.PrintODueEnqQuickReport.QRPrinter.Free;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.QRPrinter := nil;
        RTFFilter.Free;
      end;
    end
  else
  if sAttachmentType = 'HTML' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(HTMLFilter);
  ...
  if sAttachmentType = 'PDF' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(PDFFilter);
      finally
        PBRPODueEnqFrm.PrintODueEnqQuickReport.QRPrinter.Free;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.QRPrinter := nil;
        PDFFilter.Free;
  ...
  if sAttachmentType = 'GIF' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(GIFFilter);
  ...
  if sAttachmentType = 'JPEG' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(JPEGFilter);
  ...
  if sAttachmentType = 'BMP' then
    begin
      ...
      try
        PBRPODueEnqFrm.PrintODueEnqQuickReport.Prepare;
        PBRPODueEnqFrm.PrintODueEnqQuickReport.ExportToFilter(BMPFilter);
