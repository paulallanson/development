...
var
  STEmailListFrm: TSTEmailListFrm;
...
procedure TSTEmailListFrm.FormCreate(Sender: TObject);
begin
...
procedure TSTEmailListFrm.EmailListGridClick(Sender: TObject);
begin
...
procedure TSTEmailListFrm.FormShow(Sender: TObject);
var
  IniFile: TIniFile;
  defAttach: string;
  irow: integer;
...
function TSTEmailListFrm.cellleft(grid: TStringGrid; Col: Integer): Integer;
var
  i: Integer;
  t: Integer;
begin
...
function TSTEmailListFrm.celltop(grid: TStringGrid; Row: Integer): Integer;
var
  i: Integer;
  t: Integer;
begin
...
procedure TSTEmailListFrm.cmbExportFilterClick(Sender: TObject);
begin
  with EmailListGrid do
  begin
...
procedure TSTEmailListFrm.EmailListGridDrawCell(Sender: TObject; ACol,
