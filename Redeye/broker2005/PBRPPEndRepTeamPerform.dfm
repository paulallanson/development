object PBRPPEndRepTeamPerformFrm: TPBRPPEndRepTeamPerformFrm
  ...
  object qryRepTeams: TFDQuery
    ...
    SQL.Strings = (
      ...
      'FROM Sales_profit'
      '      LEFT JOIN Rep_Team'
      '        ON Sales_profit.Rep_Team = Rep_Team.Rep_Team'
      'WHERE Period >= :Start and Period <= :Finish AND'
      '((Sales_profit.Rep_Team = :Rep_Team) or (:Rep_Team = 0))'
      'ORDER BY Rep_Team.Rep_Team_Name')
    Left = 43
    Top = 14
    ParamData = <
      item
  ...
  object qryReport: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  (Sales_Profit.Rep_Team = :Rep_Team) AND'
  ...
  object qryDummyNull: TFDQuery
    ...
    SQL.Strings = (
      ...
      'WHERE'
        ...
        'Finish)) AND'
      '  (Sales_Profit.category = :Category) AND'
      '  (Sales_Profit.Rep_Team IS NULL) AND'
  ...
  object qryDummy: TFDQuery
    ...
    SQL.Strings = (
      ...
      'WHERE'
        ...
        'Finish)) AND'
      '  (Sales_Profit.category = :Category) AND'
      '  ((Sales_Profit.Rep_Team = :Rep_Team) OR (:Rep_Team = 0)) AND'
  ...
  object qryRepTeamBudgets: TFDQuery
    ...
    SQL.Strings = (
      ...
      #9#9'Rep_Budget.Period,'
      #9#9'sum(Rep_Budget.Turnover_Value) as Turnover_Value,'
      #9#9'sum(Rep_Budget.Profit_Value) as Profit_Value, '
      
        #9#9'sum(Rep_Budget.Operating_Profit_Value) as Operating_Profit_Val' +
        'ue'
      'FROM (Rep_Team '
      #9#9'INNER JOIN Rep_Team_Member '
      #9#9#9'ON Rep_Team.Rep_Team = Rep_Team_Member.Rep_Team) '
      #9#9'INNER JOIN Rep_Budget '
      #9#9#9'ON Rep_Team_Member.Rep = Rep_Budget.Rep'
      'WHERE'#9'Rep_Team.Rep_Team = :Rep_Team and'
      #9#9'Rep_Budget.Period >= :Start_Period and'
      #9#9'Rep_Budget.Period <= :Finish_Period'
      'GROUP BY Rep_Team.Rep_Team, '
      #9#9'Rep_Team.Rep_Team_Name,'
      #9#9'Rep_Budget.Period'
      '')
    Left = 139
  ...
  object qryRepTeamSubReps: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Rep_Team_Member.Rep as Category,'
      '        Rep.Name,'
      '        Rep.Rep_Is_Sub_Rep'
      'FROM Rep_Team_Member'
      '      INNER JOIN Rep'
      '        ON Rep_Team_Member.Rep = Rep.Rep'
  ...
  object qryDummyTeam: TFDQuery
    ...
    SQL.Strings = (
      ...
      #9#9'RIGHT JOIN (Rep '
      #9#9'LEFT JOIN Sales_Profit '
      #9#9#9'ON Rep.Rep = Sales_Profit.Rep)'
  ...
  object qryDummyTeamSub: TFDQuery
    ...
    SQL.Strings = (
      ...
      #9#9'RIGHT JOIN (Rep '
      #9#9'LEFT JOIN Sales_Profit '
      #9#9#9'ON Rep.Rep = Sales_Profit.Sub_Rep)'
      ...
      'WHERE'
        ...
        '  ((Sales_Profit.Period >= :Start) AND (Sales_Profit.Period <= :' +
        'Finish)) AND'
      '  (Sales_Profit.Sub_Rep = :Category) AND'
      '  ((Sales_Profit.Rep_Team = :Rep_Team) OR (:Rep_Team = 0)) AND'
