object PBLUPriceUnitFrm: TPBLUPriceUnitFrm
  Left = 147
  Top = 100
  BorderStyle = bsDialog
  Caption = 'Look-Up A Price Unit'
  ClientHeight = 318
  ClientWidth = 450
  Color = clBtnFace
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active price unit'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Price_Unit.Price_Unit_Inactive,'
      '        Price_Unit.Use_For_Estimating'
      'From Price_Unit'
      'Where (Price_Unit.Description Like :Code_From) and'
      
        '((Price_Unit_Inactive = '#39'N'#39') or (Price_Unit_Inactive is NULL) or' +
