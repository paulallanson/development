...
type
  TSTSalesOrdDM = class(TDataModule)
    ...
    DelSOLineSQL: TFDQuery;
    AddSOLineSQL: TFDQuery;
    ...
    GetDelSOLinesSQL: TFDQuery;
    DelSQL: TFDQuery;
    GetPartDescSQL: TFDQuery;
    GetPartDetsSQL: TFDQuery;
    StoreSRC: TDataSource;
    StoreSQL: TFDQuery;
    GetCustCstCntrSQL: TFDQuery;
    GetPartDiscSQL: TFDQuery;
    GetGroupDiscSQL: TFDQuery;
    DefWHouseSQL: TFDQuery;
    UpdSOLineRepPercSQL: TFDQuery;
    AddSOLineRepPercSQL: TFDQuery;
    DelSOLineRepPercSQL: TFDQuery;
    GetRepDetsSQL: TFDQuery;
    GetCustomerSQL: TFDQuery;
    ...
    DelAllRepPercSQL: TFDQuery;
    GetCustAddrSQL: TFDQuery;
    GetOSSObySuppSQL: TFDQuery;
    qryCompanyDtls: TFDQuery;
    qryGetContactName: TFDQuery;
    qryUpdSOStatus: TFDQuery;
    GetVatRateSQL: TFDQuery;
    UpdLastInvSQL: TFDQuery;
    AddInvSQL: TFDQuery;
    UpdInvHeadSQL: TFDQuery;
    AddInvLineSQL: TFDQuery;
    AddInvHeadSQL: TFDQuery;
    GetInvoiceNoSQL: TFDQuery;
    UpdInvLineSQL: TFDQuery;
    GetInvoiceSQL: TFDQuery;
    GetExtChgsSQL: TFDQuery;
    GetExtChgSQL: TFDQuery;
    AddExtChgSQL: TFDQuery;
    UpdExtChgSQL: TFDQuery;
    GetExtChgsInvSQL: TFDQuery;
    GetSuppOTypeSQL: TFDQuery;
    GetSuppOTypeSRC: TDataSource;
    RepSourceSQL: TFDQuery;
    RepSourceSRC: TDataSource;
    GetSuppSQL: TFDQuery;
    GetSuppBrSQL: TFDQuery;
    GetPartVatRateSQL: TFDQuery;
    GetRateSQL: TFDQuery;
    GetPartSuppSQL: TFDQuery;
    DelExtChgSQL: TFDQuery;
    AddOrdExtChgSQL: TFDQuery;
    DelOrdExtChgSQL: TFDQuery;
    qryListSOwithoutPO: TFDQuery;
    dtsrcGeneral: TDataSource;
    GetDiscTypeSQL: TFDQuery;
    GetDiscTypeSRC: TDataSource;
    GetInvLineSQL: TFDQuery;
    qryGetCallOffDtls: TFDQuery;
    ...
    qryReportForms_per_Box: TWideStringField;
    ...
    qryGetDelivDtls: TFDQuery;
    qryGetPOAddChgs: TFDQuery;
    qryGetCustVat: TFDQuery;
    GetDelInvLinesSQL: TFDQuery;
    DelInvLineSQL: TFDQuery;
    DelInvSQL: TFDQuery;
    GetInvDetsSQL: TFDQuery;
    QryGetAdHoc: TFDQuery;
    GetStockSQL: TFDQuery;
    GetSOSerialNosSQL: TFDQuery;
    DelSOSerialNosSQL: TFDQuery;
    AddSerialNosSQL: TFDQuery;
    AddStStkSerialNosSQL: TFDQuery;
    DelStStkSerialNosSQL: TFDQuery;
    GetNextStStkSerialNoSQL: TFDQuery;
    GetStockSerialNosSQL: TFDQuery;
    MarkupSQL: TFDQuery;
    srcMarkup: TDataSource;
    qryDelSOSerialNos: TFDQuery;
    qryDelSOSundry: TFDQuery;
    qryDelSORep: TFDQuery;
    qryDelSONarrative: TFDQuery;
    qryDelSOPORef: TFDQuery;
    qrySOLineInvdQty: TFDQuery;
    qrySOLineDelivQty: TFDQuery;
    qryPObySO: TFDQuery;
    qryDelStoreStockSISOAlloc: TFDQuery;
    qrySelContractbySO: TFDQuery;
    qryGetBranchRep: TFDQuery;
    qryDelStrStckSOLineAlloc: TFDQuery;
    AddJobBagSQL: TFDQuery;
    GetLastJBLineSQL: TFDQuery;
    DelJobBagSQL: TFDQuery;
    UpdJobBagSQL: TFDQuery;
    qryGetJBLine: TFDQuery;
    qryGetProdLoc: TFDQuery;
    qryGetAccountMgr: TFDQuery;
    qryGetAccountTeam: TFDQuery;
    UpdSOHeadStatusSQL: TFDQuery;
    GetPartTransferSQL: TFDQuery;
    GetPartAllocationSQL: TFDQuery;
    qrySOAddCharge: TFDQuery;
    CheckSOStatusSQL: TFDQuery;
    UpdOrderStatusSQL: TFDQuery;
    UpdSalesOrderLineSQL: TFDQuery;
    qryGetPartAllocbySOL: TFDQuery;
    qryUpdPartAlloc: TFDQuery;
    qryUpdJobBagLine: TFDQuery;
    qryJBUpHead: TFDQuery;
    qrySalesOrderJB: TFDQuery;
    qryJBChkStatus: TFDQuery;
    GetStoreStockSQL: TFDQuery;
    DeletePartTransferSQL: TFDQuery;
    UpdatePartTransferSQL: TFDQuery;
    updSOLValuesSQL: TFDQuery;
    qryGetJBRequest: TFDQuery;
    GetLastJBRequestSQL: TFDQuery;
    AddJobBagReqSQL: TFDQuery;
    DelJobBagReqSQL: TFDQuery;
    qryGetSODelivAdd: TFDQuery;
    qryGetCustCC: TFDQuery;
    qryGetBranchCC: TFDQuery;
    qryGetCustBranch: TFDQuery;
    qryGetSOLastDelivery: TFDQuery;
    qryVat: TFDQuery;
    dtsVat: TDataSource;
    qryUpdateContactStatus: TFDQuery;
    AddDelivLineDetSQL: TFDQuery;
    AddDelivDetSQL: TFDQuery;
    DelDelivDetsSQL: TFDQuery;
    DelDelivLineDetsSQL: TFDQuery;
    ...
    procedure HandleSOLine(Query: TFDQuery; const inx: Integer; SO: TSalesOrder);
    procedure setInvToAccount(const Value: String);
    procedure UpdateRepPerc(SO: TSalesOrder);
    procedure HandleSORepPerc(Query: TFDQuery; const inx: integer; SO: TSalesOrder);
...
procedure TSTSalesOrdDM.HandleSOLine(Query: TFDQuery; const inx: Integer; SO: TSalesOrder);
var
  i: Integer;
begin
...
procedure TSTSalesOrdDM.HandleSORepPerc(Query: TFDQuery; const inx: integer; SO:TSalesOrder);
var
  i: Integer;
begin
