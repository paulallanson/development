object PBLUPrdTypCapFrm: TPBLUPrdTypCapFrm
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active capabilities'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Product_TypeCapability.inactive'
      'From    Product_TypeCapability'
      
        'Where   (Product_TypeCapability.Product_Type = :Product_Type) an' +
        'd'
      '        (Product_TypeCapability.Description Like :Code_From) and'
      
        '        ((Product_TypeCapability.inactive = '#39'N'#39') or (Product_Typ' +
        'eCapability.inactive is NULL) or (Product_TypeCapability.inactiv' +
        'e = :Inactive)) AND'
      '        ((Product_TypeCapability.Default_For_all is null) or'
      '         (Product_TypeCapability.Default_For_all <> '#39'Y'#39'))'
