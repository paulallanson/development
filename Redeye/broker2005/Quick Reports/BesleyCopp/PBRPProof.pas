...
VSS Info:
$Header: /PBL D5/Quick Reports/Formpro/PBRPProof.pas 1     27/05/03 12:33 Paul $
 ...
 * 
 * *****************  Version 3  *****************
 * User: Paul         Date: 6/01/:3    Time: 16:49
 * Updated in $/PBL D5/Quick Reports/PMS
 * Changed layout slightly
 * 
 * *****************  Version 2  *****************
 * User: Paul         Date: 23/12/:2   Time: 16:30
 * Updated in $/PBL D5/Quick Reports/PMS
 * Changed format of the proof approval form
 * 
 * *****************  Version 1  *****************
...
uses
  ...
  DB, StdCtrls, QuickRpt, QRExpr, Qrctrls, ExtCtrls, CCSPrint,
  CCSCommon,
...
//    self.qrmemoCmpnyNm.Enabled := true;
  end
  else
  begin
    ReportImage.Enabled := false;
//    self.qrmemoCmpnyNm.Enabled := false;
  end;
  ...
  begin
    ...
    begin
      ...
      Lines.Append(Trim(GetCompSQL.Fields[3+irow].AsString)) ;
    end;
...
*)
  PONumberLbl.Caption := 'Purchase Order: '
