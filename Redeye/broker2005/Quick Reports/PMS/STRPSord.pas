...
uses
  ...
  Qrctrls, QuickRpt, ExtCtrls, Db, DBTables, StdCtrls, gtQrCtrls, CCSPrint;
...
type
  TSTRPSordFrm = class(TForm)
    ...
    SOrdLineNoQRLabel: TgtQRLabel;
    PartCodeQRLabel: TgtQRLabel;
    PartDescrQRLabel: TgtQRLabel;
    SellPriceQRLabel: TgtQRLabel;
    QRLabel3: TgtQRLabel;
    QRLabel7: TgtQRLabel;
    QRLabel8: TgtQRLabel;
