...
type
  TPBRPSalesInvFrm = class(TForm)
    ...
    QRLblInvno: TgtQRLabel;
    QRLblInvDt: TgtQRLabel;
    QRLblAcc: TgtQRLabel;
    QRLblCustRef: TgtQRLabel;
    QRLblOurRef: TgtQRLabel;
    QRLabel1: TgtQRLabel;
    QRLabel2: TgtQRLabel;
    QRLabel3: TgtQRLabel;
    ...
    QRLblQtyInv: TgtQRLabel;
    QRLblDescription: TgtQRLabel;
    QRlblPrcUnt: TgtQRLabel;
    QRLblTotGoods: TgtQRLabel;
    QRLblGoodsVat: TgtQRLabel;
    QRLblLn: TgtQRLabel;
    QRLblProduct: TgtQRLabel;
    ChldBndHead: TQRChildBand;
    QRLblDesc: TgtQRLabel;
    QRLblNet: TgtQRLabel;
    QRLblVat: TgtQRLabel;
    QRLabel4: TgtQRLabel;
    ...
    qrlblFormRef: TgtQRLabel;
    CompanyAddMemo: TgtQRMemo;
    qryCompany: TQuery;
...
begin
  ...
  if not bInvoice then
    ...
    begin
      QRLabel3.Caption := 'Invoice Value';
      QRLblInvNo.Caption := 'Invoice No';
      QRLblInvDt.Caption := 'Invoice Date';
      QRLblInv.Caption := 'INVOICE';
    end;
