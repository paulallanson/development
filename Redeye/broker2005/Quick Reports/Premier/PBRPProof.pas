...
VSS Info:
$Header: /PBL D5/Quick Reports/Horner Bros/PBRPProof.pas 1     19/06/:3 14:48 Paul $
 ...
 * 
 * *****************  Version 1  *****************
 * User: Paul         Date: 13/11/:2   Time: 11:34
 * Created in $/PBL D5/Quick Reports/ImageForms
 * Initial take on of Image Forms Documents
 * 
 * *****************  Version 4  *****************
...
uses
  ...
  DB, DBTables, StdCtrls, QuickRpt, QRExpr, Qrctrls, ExtCtrls, CCSPrint, CCSCommon, gtQrCtrls;
...
type
  TPBRPProofFrm = class(TForm)
    ...
    LabQuantity: TgtQRLabel;
    LabJobTitle: TgtQRLabel;
    LabDepth: TgtQRLabel;
    LabWidth: TgtQRLabel;
    ...
    qryZero: TQuery;
    GetLastSQL: TQuery;
    lblProofRevision: TgtQRLabel;
    UpdPOSQL: TQuery;
    lblCompanyAddress: TgtQRLabel;
...
uses PBImages, Printers, pbMainMenu;
