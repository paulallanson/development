object PBRPSalesInvFrm: TPBRPSalesInvFrm
  ...
  object InvoiceReport: TQuickRep
    ...
    object QRBndPgHead: TQRBand
      ...
      Frame.DrawRight = False
      AlignToBottom = False
      BeforePrint = QRBndPgHeadBeforePrint
      Color = clWhite
      ForceNewColumn = False
      ForceNewPage = False
      Size.Values = (
      ...
      object CompanyAddMemo: TgtQRMemo
        Left = 424
        Top = 34
        Width = 327
        Height = 103
    ...
    object ChldBndDtl: TQRChildBand
      Left = 19
      Top = 522
      Width = 756
      Height = 24
    ...
    object QRSordChldbnd: TQRChildBand
      Left = 19
      Top = 573
      Width = 756
      Height = 23
      ...
      Frame.DrawRight = False
      AlignToBottom = False
      BeforePrint = QRSordChldbndBeforePrint
      Color = clWhite
      ForceNewColumn = False
      ForceNewPage = False
      Size.Values = (
      ...
      object QRLblProduct: TgtQRLabel
        Left = 32
        Top = 2
        Width = 95
        Height = 17
      ...
      object QRLblTotGoods: TgtQRLabel
        Left = 606
        Top = 2
        Width = 88
        Height = 19
      ...
      object QRLblGoodsVat: TgtQRLabel
        Left = 682
        Top = 2
        Width = 66
        Height = 17
    ...
    object ChldBndHead: TQRChildBand
      Left = 19
      Top = 596
      Width = 756
      Height = 30
    ...
    object ChldBndSOHead: TQRChildBand
      Left = 19
      Top = 626
      Width = 756
      Height = 40
    ...
    object ChldBndFormRef: TQRChildBand
      ...
      Size.Values = (
        71.4375
        2000.25)
      ParentBand = ChldBndDtl
      object qrlblFormRef: TgtQRLabel
        Left = 81
        Top = 4
        Width = 57
        Height = 18
