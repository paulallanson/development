...
(*      CustomerAddMemo.font.color := clred;
      BranchAddMemo.font.color := clred;
      InvoiceNumberlbl.Font.color := clred;
      InvoiceDateLbl.font.color := clred
...
//  else
  qrlblVatRate.caption := formatfloat('0.00%',(roundfloat(InvLineSRC.Dataset.FieldByName('Vat_Rate').AsFloat,2)));
...
*)
  ...
  ExtrasVATLbl.Caption := formatfloat('0.00%',(qryInvCharges.FieldByName('Vat_Rate').AsFloat));
