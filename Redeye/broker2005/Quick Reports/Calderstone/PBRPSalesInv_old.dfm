object PBRPSalesInvFrm: TPBRPSalesInvFrm
  ...
  object InvoiceReport: TQuickRep
    ...
    object InvoiceFooter: TQRBand
      ...
      object qrlblCompanyReg: TQRMemo
        Tag = 1
        Left = 10
        Top = 228
        Width = 745
        ...
        Lines.Strings = (
            ...
            'Registered office:  Peterbridge House, The Lakes, Northampton, N' +
            'N4 7HB. UK')
        ParentFont = False
        Transparent = False
        WordWrap = True
      ...
      object qrlblCompanyPort: TQRMemo
        Tag = 1
        Left = 10
        Top = 228
        Width = 745
      ...
      object qrlblTotalGoods: TQRLabel
        Tag = 1
        Left = 529
        Top = 29
        Width = 68
    ...
    object QRBand1: TQRBand
      ...
      object qrHeadersShape: TQRShape
        Tag = 1
        Left = 8
        Top = 387
        Width = 750
      ...
      object qrlblOrdernumber: TQRLabel
        Tag = 3
        Left = 493
        Top = 320
        Width = 111
    ...
    object LineCharges: TQRSubDetail
      ...
      object qrlblExtrasVat: TQRLabel
        Left = 654
        Top = 1
        Width = 76
        Height = 18
  ...
  object InvHeadSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Sales_Invoice_Status.Description,'
      '        Invoice_Location.Logo_Path'
      ...
      '      INNER JOIN Sales_Invoice'
        ...
        '        ON (Customer_Branch.Branch_no = Sales_Invoice.Branch_no)' +
        ' AND (Customer_Branch.Customer = Sales_Invoice.Customer))'
      '        ON Customer.Customer = Customer_Branch.Customer)'
        ...
        '        ON Invoice_Location.Invoice_Location = Sales_Invoice.Inv' +
        'oice_Location'
      'where'
      '('
      ...
      ') and'
      '(Sales_Invoice.Sales_invoice_Status = 10)'
  ...
  object InvRHeadSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        ON Customer.Customer = Customer_Branch.Customer)'
        ...
        'oice_Location'
      'where'
      '(Sales_Invoice.Sales_invoice_Status = 20)'
  ...
  object qryInvLineCharges: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'select Sales_invoice_Add_Charge.*, VAT_Code.VAT_Rate'
      'from Sales_invoice_Add_Charge, VAT_Code'
