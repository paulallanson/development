...
type
  TSTPOrdRepFrm = class(TForm)
    ...
    QRLabel2: TgtQRLabel;
    DAddr1QRLabel: TgtQRLabel;
    DAddr2QRLabel: TgtQRLabel;
    DAddr3QRLabel: TgtQRLabel;
    DAddr4QRLabel: TgtQRLabel;
    DAddr5QRLabel: TgtQRLabel;
    DAddr6QRLabel: TgtQRLabel;
...
uses STPordRSl, PBSendFax, pbMainMenu, CCSCommon, PBImages;
