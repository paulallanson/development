...
uses
  ...
  CCSPrint, PBPOObjects, qrprntr, printers, QrExport, gtQrCtrls;
...
*)
  ...
  with qrmCompany do
    begin
      ...
      CompSQL.open;
      Lines.Clear;
      Lines.Append(Trim(CompSQL.Fields[0].AsString) + ', ' + Trim(CompSQL.Fields[1].AsString) + ' ' + Trim(CompSQL.Fields[2].AsString) + ' ' + Trim(CompSQL.Fields[3].AsString)) ;
      Lines.Append(Trim(CompSQL.Fields[4].AsString) + ' ' + Trim(CompSQL.Fields[5].AsString) + ' Tel: ' + Trim(CompSQL.FieldByName('Phone').AsString));
    end;
end;
