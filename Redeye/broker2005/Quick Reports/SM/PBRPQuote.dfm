object frmPBRPQuote: TfrmPBRPQuote
  ...
  object qrpDetails: TQuickRep
    ...
    object qrbPageHeader: TQRBand
      ...
      object qrlblEndUser: TgtQRLabel
        Left = 8
        Top = 179
        Width = 48
        Height = 16
      ...
      object qrlblEndUserName: TgtQRDBText
        Left = 77
        Top = 179
        Width = 409
        Height = 16
    ...
    object qrbDeptFooter: TQRBand
      ...
      object gtlblQuantity: TgtQRLabel
        Left = 400
        Top = 5
        Width = 41
        Height = 16
    ...
    object qrbLineDetail: TQRSubDetail
      ...
      PrintBefore = False
      PrintIfEmpty = True
      object gtlblQuoteUnitPrice: TgtQRLabel
        Left = 428
        Top = 2
        Width = 91
        Height = 16
      ...
      object gtlblQuoteQuantity: TgtQRDBText
        Left = 386
        Top = 2
        Width = 63
        Height = 16
      ...
      object gtlblQuoteVat: TgtQRLabel
        Left = 682
        Top = 2
        Width = 66
        Height = 16
      ...
      object gtlblQuoteTotalPrice: TgtQRLabel
        Left = 586
        Top = 2
        Width = 96
        Height = 16
      ...
      object gtlblQuotePriceUnit: TgtQRDBText
        Left = 532
        Top = 2
        Width = 63
        Height = 16
    ...
    object qrbSupplyLines: TQRSubDetail
      ...
      PrintBefore = False
      PrintIfEmpty = True
      object gtlblSupplyVat: TgtQRLabel
        Left = 678
        Top = 2
        Width = 70
        Height = 16
      ...
      object gtlblSupplyQuantity: TgtQRDBText
        Left = 386
        Top = 2
        Width = 63
        Height = 16
      ...
      object gtlblSupplyUnitPrice: TgtQRDBText
        Left = 461
        Top = 2
        Width = 63
        Height = 16
      ...
      object gtlblSupplyTotalPrice: TgtQRLabel
        Left = 582
        Top = 2
        Width = 100
        Height = 16
      ...
      object gtlblSupplyPriceUnit: TgtQRDBText
        Left = 533
        Top = 2
        Width = 63
        Height = 16
    ...
    object qrbQuoteFooter: TQRBand
      ...
      Size.Values = (
        ...
        2000.250000000000000000)
      BandType = rbSummary
      object gtlblTotalGross: TgtQRLabel
        Left = 663
        Top = 51
        Width = 86
        Height = 17
      ...
      object gtlblTotalVat: TgtQRLabel
        Left = 679
        Top = 27
        Width = 70
        Height = 17
