  ...
  begin
    with qrmemCompanyAddress do
      begin
        ...
        CompSQL.open;
        Lines.Clear;
        Lines.Append('Accounts,' + Trim(CompSQL.Fields[1].AsString));
        Lines.Append(Trim(CompSQL.Fields[2].AsString) + ', ' + Trim(CompSQL.Fields[3].AsString) + ' ' + Trim(CompSQL.Fields[4].AsString) + ' ' + Trim(CompSQL.Fields[5].AsString)) ;

        {Finally, add the phone number} ;
        Lines.Append('Telephone: ' + Trim(CompSQL.FieldByName('Phone').AsString) + ' Fax: ' + Trim(CompSQL.FieldByName('Fax_Number').AsString));
      end;
