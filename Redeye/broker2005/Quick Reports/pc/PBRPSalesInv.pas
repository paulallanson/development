...
VSS Info:
$Header: /PBL D5/Quick Reports/Formpro/PBRPSalesInv.pas 7     23/09/03 11:18 Paul $
$History: PBRPSalesInv.pas $
 * 
 * *****************  Version 7  *****************
 * User: Paul         Date: 23/09/03   Time: 11:18
 * Updated in $/PBL D5/Quick Reports/Formpro
 * Changed to print Credit Note labels
 * 
 * *****************  Version 6  *****************
 * User: Janiner      Date: 4/09/:3    Time: 11:56
 * Updated in $/PBL D5/Quick Reports/Formpro
 * Delivery address memo is in page footer which was getting overwritten
 * by group header of next invoice to print. Move retrieval of deliv
 * address to after group header print event.
 * 
 * *****************  Version 5  *****************
 * User: Janiner      Date: 3/09/:3    Time: 16:21
 * Updated in $/PBL D5/Quick Reports/Formpro
 * change format slightly to include delivery address, and increase
 * description line if not from a production order. 
 * 
 * *****************  Version 4  *****************
 * User: Janiner      Date: 3/07/:3    Time: 15:46
 * Updated in $/PBL D5/Quick Reports/Formpro
 * Line fields up with column headings.
 * 
 * *****************  Version 3  *****************
 ...
 * 
 * *****************  Version 2  *****************
 * User: Paul         Date: 2/06/:3    Time: 16:34
 * Updated in $/PBL D5/Quick Reports/Formpro
 * Changed to use the Broadsword version as the basis of Formpro versions.
 * 
 * *****************  Version 17  *****************
 * User: Paul         Date: 20/05/:3   Time: 10:51
 * Updated in $/PBL D5/Quick Reports/BroadSword
 * Changed to resolve access violation problem
 * 
 * *****************  Version 16  *****************
 * User: Paul         Date: 19/05/:3   Time: 12:04
 * Updated in $/PBL D5/Quick Reports/BroadSword
 * Changed to fit the details in the pre-printed layout
 * 
 * *****************  Version 15  *****************
 * User: Paul         Date: 13/05/:3   Time: 11:39
 * Updated in $/PBL D5/Quick Reports/BroadSword
 * changed to pick up the correct delivery address when sales order
 * 
 * *****************  Version 14  *****************
 * User: Paul         Date: 17/03/:3   Time: 17:19
 * Updated in $/PBL D5/Quick Reports/BroadSword
...
begin
  ...
  qrshp2.Top := 468;
  qrshp3.Top := 404;
  qrshp4.Top := qrshp3.Top;
  qrshp5.Top := qrshp3.Top;
  qrshp6.Top := qrshp2.Top;
  qrshp7.Top := qrshp1.Top;
  ...
  qrshp4.Height := 497;
  qrshp5.Height := 497;
  qrshp6.Height := qrshp2.Height;
  qrshp7.Height := qrshp1.Height;
