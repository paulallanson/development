...
type
  TPBRPJBDraftFrm = class(TForm)
    ...
    qrlblVatRegistration: TgtQRLabel;
...
begin
  ...
  if (GetDetsQuery.fieldbyname('Job_Bag_Price_Unit').asinteger <> 0) and (dmBroker.UsePackPricing) then
    begin
