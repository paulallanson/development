...
type
  TfrmPBRPJobBagSched = class(TForm)
    ...
    gtQRLabel2: TQRLabel;
    gtQRLabel3: TQRLabel;
    qrlblDataAvailable: TQRLabel;
    gtQRShape1: TQRShape;
    gtQRLabel4: TQRLabel;
    gtQRLabel5: TQRLabel;
    gtQRShape2: TQRShape;
    gtQRShape3: TQRShape;
    qrlblPDFProofArtwork: TQRLabel;
    qrlblPDFProofRequired: TQRLabel;
    gtQRLabel8: TQRLabel;
    gtQRShape4: TQRShape;
    qrlblPDFProofApproval: TQRLabel;
    gtQRLabel6: TQRLabel;
...
procedure TfrmPBRPJobBagSched.BuildNotes(aQuery: TFDQuery;
