...
VSS Info:
$Header: /PBL D5/Quick Reports/Nexus/PBRPSalesInv.pas 12    27/08/03 14:55 Paul $
$History: PBRPSalesInv.pas $
 * 
 * *****************  Version 12  *****************
 * User: Paul         Date: 27/08/03   Time: 14:55
 * Updated in $/PBL D5/Quick Reports/Nexus
 * reformatted report to print multiple pages round the new letterhead
 * 
 * *****************  Version 11  *****************
 ...
 * 
 * *****************  Version 10  *****************
 * User: Paul         Date: 15/05/:3   Time: 12:20
 * Updated in $/PBL D5/Quick Reports/Nexus
 * Changed to print over multiple pages
 * 
 * *****************  Version 9  *****************
 * User: Paul         Date: 31/03/:3   Time: 9:40
 * Updated in $/PBL D5/Quick Reports/Nexus
 * 
 * *****************  Version 8  *****************
 ...
 * 
 * *****************  Version 6  *****************
 * User: Paul         Date: 7/02/:3    Time: 16:25
 * Updated in $/PBL D5/Quick Reports/Nexus
 * Changes made to invoice print
 * 
 * *****************  Version 5  *****************
 * User: Paul         Date: 30/01/:3   Time: 16:11
 * Updated in $/PBL D5/Quick Reports/Nexus
 * Changed to new format invoice which allows multiple lines
 * 
 * *****************  Version 5  *****************
...
uses
  ...
  CCSCommon, PBPOObjects, qrprntr, printers,
...
//    GoodsLbl.Caption := formatfloat('0.00',(InvLineSRC.Dataset.FieldByName('Goods_Value').AsFloat));
  ...
  rVatValue := StrToFloatDef(GoodsTotalLbl.Caption, 0, FormatSettings) *
