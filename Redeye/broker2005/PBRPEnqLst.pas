...
type
  TPBRPEnqLstFrm = class(TForm)
    ...
    QRLabel1: TQRLabel;
    QRLblCst: TQRLabel;
    GetEnquiriesSQLCustName: TWideStringField;
    GetEnquiriesSQLEnquiry: TIntegerField;
    GetEnquiriesSQLLine: TIntegerField;
    GetEnquiriesSQLForm_Description: TWideStringField;
    GetEnquiriesSQLName: TWideStringField;
    GetEnquiriesSQLBranch_Name: TWideStringField;
    GetEnquiriesSQLName_1: TWideStringField;
    GetEnquiriesSQLDate_Point: TDateTimeField;
    GetEnquiriesSQLQuote_Required_By: TDateTimeField;
    QRLblStatus: TQRLabel;
    QRLblCntct: TQRLabel;
    GetEnquiriesSQLName_2: TWideStringField;
    GetEnquiriesSQLDescription: TWideStringField;
    qrgSortBy: TQRGroup;
    ...
    QRlblLve: TQRLabel;
    qrlblDtRng: TQRLabel;
    GetEnquiriesSQLEnq_InActive: TWideStringField;
    QRLabel2: TQRLabel;
    QRDBText3: TQRDBText;
