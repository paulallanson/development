...
uses
  ...
  Db, DBTables, contnrs, PBNarrativeDM;
...
type
  TPBEnqDM = class(TDataModule)
    ...
    GetCustRepSQL: TQuery;
    CustRepSRC: TDataSource;
    AddEnqLineSQL: TQuery;
    AddEnqLineQtySQL: TQuery;
    AddEnqSupplierSQL: TQuery;
    AddEnqSuppQtySQL: TQuery;
    AddEnqLinePartSQL: TQuery;
    qrySelEnquiry: TQuery;
    qryInsEnquiry: TQuery;
    qryUpdEnquiry: TQuery;
    qrySelCustDetails: TQuery;
    qrySelCustBrnchDetails: TQuery;
    qrySelContactDetails: TQuery;
    qrySelCustContactNo: TQuery;
    qrySelCustRepNo: TQuery;
    qrySelRepDtls: TQuery;
    qrySelOperators: TQuery;
    qrySelOperator: TQuery;
    qrySelOperatorNo: TQuery;
    qrySelEnqLine: TQuery;
    qrySelNoOfEnqLines: TQuery;
    qryInsEnqLine: TQuery;
    qryUpdEnqLine: TQuery;
    qrySelProdType: TQuery;
    qrySelFormRef: TQuery;
    qrySelPart: TQuery;
    qrySelNoOfEnqParts: TQuery;
    qryInsEnqLinePart: TQuery;
    qryUpdEnqLinePart: TQuery;
    qryDelEnqLinePart: TQuery;
    qryDelEnqLine: TQuery;
    qryDelEnq: TQuery;
    qryDelEnqLineParts: TQuery;
    qryPaperDtls: TQuery;
    qrySelDefCustRep: TQuery;
    qrySelProdTypeQs: TQuery;
    qrySelNoOfProdTypeQs: TQuery;
    qrySelProdTypeQList: TQuery;
    qrySelEnqAnswer: TQuery;
    qrySelEnqLineQtys: TQuery;
    qrySelEnqLineQty: TQuery;
    qrySelPriceUnit: TQuery;
    qrySelSupplier: TQuery;
    qrySelSupplrBrnch: TQuery;
    qrySelEnqQteSupls: TQuery;
    qrySelSuppEnqQtyPrice: TQuery;
    qrySelNarrative: TQuery;
    qryDelNarrative: TQuery;
    qryInsNarrative: TQuery;
    qrySelMaxNarrative: TQuery;
    qrySelSuppRespns: TQuery;
    qryInsSuppRespns: TQuery;
    qryDelSuppRespns: TQuery;
    qryUpdSuppRespns: TQuery;
    qrySelPriceUnits: TQuery;
    qrySelPriceUnitNo: TQuery;
    qryDelLineQty: TQuery;
    qryInsLineQty: TQuery;
    qryUpdLineQty: TQuery;
    qryInsSuppEnqQty: TQuery;
    qryUpdSuppEnqQty: TQuery;
    qryDelSuppEnqQty: TQuery;
    qrySelNoOfCapbltys: TQuery;
    qrySelCapability: TQuery;
    qrySelEnqLineCpbltys: TQuery;
    qrydelEnqLineCpbltys: TQuery;
    qryInsEnqLineCpblty: TQuery;
    qryInsEnqAnswer: TQuery;
    qryUpdEnqAnswer: TQuery;
    qryDelEnqAnswer: TQuery;
    qrySelSuppBrnchConts: TQuery;
    qrySelEnqAddNts: TQuery;
    qrySelEnqAddNote: TQuery;
    qryDelEnqAddNote: TQuery;
    qryInsEnqAddNote: TQuery;
    qryUpdEnqAddNote: TQuery;
    qrySelSuppEnqAddChrg: TQuery;
    qrySelSuppEnqAddChrgs: TQuery;
    qryDelSuppEnqAddChrg: TQuery;
    qryInsSuppEnqAddChrg: TQuery;
    qryUpdSuppEnqAddChrg: TQuery;
    qryDelSuppEnqAddChrgs: TQuery;
    dtsrcSuppBrnchConts: TDataSource;
    qryInsQuote: TQuery;
    qryReserveSlot: TQuery;
    qryGetReservedSlot: TQuery;
    qryDelSuppEnqQtys: TQuery;
  private
