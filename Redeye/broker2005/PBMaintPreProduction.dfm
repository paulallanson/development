object PBMaintPreProductionFrm: TPBMaintPreProductionFrm
  Left = 152
  Top = 121
  ...
  object GetLastSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select Pre_Production_Process'
      'From Pre_Production_Process'
      'Where Pre_Production_Process_Desc = :GUID'
      ' ')
    Left = 192
    Top = 24
    ParamData = <
  ...
  object AddSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Insert Into Pre_Production_Process'
      '        (Pre_Production_Process,'
      '        Pre_Production_Process_Desc)'
      
        'Select Max(Pre_Production_Process)+1, :GUID From Pre_Production_' +
        'Process'
      ''
      ''
      ''
  ...
  object UpdSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Update Pre_Production_Process'
      
        'Set     Pre_Production_Process_Desc = :Pre_Production_Process_De' +
        'sc '
      'Where'
      '(Pre_Production_Process = :Pre_Production_Process) '
      ''
      ' ')
    Left = 144
    Top = 16
    ParamData = <
      item
        Name = 'Pre_Production_Process_Desc'
      end
      item
        Name = 'Pre_Production_Process'
      end>
  end
  object DelSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Delete From Pre_Production_Process'
      'Where'
      '(Pre_Production_Process = :Pre_Production_Process)'
      ' ')
    Left = 240
