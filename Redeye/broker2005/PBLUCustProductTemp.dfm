object PBLUCustProductTempFrm: TPBLUCustProductTempFrm
  Left = 272
  Top = 155
  BorderStyle = bsDialog
  Caption = 'Look-up Customer Product Templates'
  ClientHeight = 341
  ClientWidth = 450
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'Product_Template'
        Title.Caption = 'Product Template'
        Width = 216
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Customer_Product_Template'
        ...
        'Where Customer = :Customer and (Product_Template Like :Code_From' +
        ')'
