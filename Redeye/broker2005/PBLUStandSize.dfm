object PBLUStandSizeFrm: TPBLUStandSizeFrm
  Left = 136
  Top = 165
  BorderStyle = bsDialog
  Caption = 'Look-up a standard paper size'
  ClientHeight = 309
  ClientWidth = 432
  Color = clBtnFace
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Paper_Size.Paper_Width_mm,'
      '        Paper_Size.Paper_Depth_mm,'
      '        Paper_Size.Short_Description,'
      '        Paper_Size.A4_Multiplier'
      'From Paper_Size'
      'Where (Paper_Size.Description Like :Code_From)'
