object PBLUQAOperatorFrm: TPBLUQAOperatorFrm
  Left = 188
  Top = 136
  BorderStyle = bsDialog
  Caption = 'Look up Quality Assurance details'
  ClientHeight = 321
  ClientWidth = 427
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'QA_Operator_Name'
        Title.Caption = 'Quality Assurance User'
        Width = 219
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      'Select *'
      'From QA_Operator'
      'Where (QA_Operator_Name Like :Code_From) and '
