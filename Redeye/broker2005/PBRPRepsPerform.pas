...
type
  TPBRPRepsPerformFrm = class(TForm)
  ...
  public
    ...
    PrinterSettings: TPrinterSettings;
      ...
      Matrix: array [1..12,1..2] of Real;
      tot: array [1..4,1..2] of real;
      RepNo: array [0..12] of integer;
      repname: array [0..12] of TQRLabel;
      Heading: array [0..12] of TQRLabel;
      underline: array [0..12] of TQRLabel;
      Detail: array [0..12,1..4] of TQRLabel;
      Noofrecs: integer;
  end;
...
var
  PBRPRepsPerformFrm: TPBRPRepsPerformFrm;

implementation

{$R *.DFM}

procedure TPBRPRepsPerformFrm.QckRpRpsPrftBeforePrint(
...
procedure TPBRPRepsPerformFrm.PageHeaderBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPBRPRepsPerformFrm.PageHeaderLeftBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := PageHeaderLeft.Tag = 0;
end;

procedure TPBRPRepsPerformFrm.QRFootPg1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx: integer;
begin
...
procedure TPBRPRepsPerformFrm.PageHeaderRightBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := PageHeaderLeft.Tag = 2;
end;

procedure TPBRPRepsPerformFrm.QRSubDetailpg1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
var
count: integer;
noofcols: integer;
...
procedure TPBRPRepsPerformFrm.QRGrpHeadPg2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
if noofrecs > 3 then
...
procedure TPBRPRepsPerformFrm.QRSubDetailpg2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
var
noofcols : integer;
count: integer;
...
procedure TPBRPRepsPerformFrm.QRGrpPg1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
printband := false;
end;

procedure TPBRPRepsPerformFrm.QRGrpPg2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
printband := false;
end;

procedure TPBRPRepsPerformFrm.QRDtlpg1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx : integer;
begin
...
procedure TPBRPRepsPerformFrm.QRDtlpg2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx : integer;
toloop : integer;
...
procedure TPBRPRepsPerformFrm.CreateTotals(Sender: TObject);
var
idx : integer;
begin
...
procedure TPBRPRepsPerformFrm.PageHeaderMiddleBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 PrintBand := PageHeaderleft.Tag = 1;
end;

procedure TPBRPRepsPerformFrm.QRGrpHeadPg3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
if noofrecs > 7 then
  qckrpRpsPrft.newpage;
...
procedure TPBRPRepsPerformFrm.QRGrpPg3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
printband := false;
end;

procedure TPBRPRepsPerformFrm.QRSubDetailpg3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
var
noofcols : integer;
count: integer;
...
procedure TPBRPRepsPerformFrm.QRDtlPg3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx : integer;
begin
...
procedure TPBRPRepsPerformFrm.QRFootPg2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx : integer;
toloop : integer;
...
procedure TPBRPRepsPerformFrm.GetDetails(Sender: TObject);
var
idx: integer;
begin
  with sqlRep do
  begin
    ...
    ParamByName('Period_To').AsInteger := FinishPeriod;
    ParamByname('Period_From').AsInteger := StartPeriod;
    Open;
  ...
  sqlRepPrft.ParamByName('Period_To').AsInteger := FinishPeriod;
  sqlRepPrft.ParamByname('Period_From').AsInteger := StartPeriod;
  sqlRepPrft.open;

end;

procedure TPBRPRepsPerformFrm.QRFootpg3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
idx : integer;
toloop : integer;
...
procedure TPBRPRepsPerformFrm.ClearTotals(Sender: TObject);
var
icount : integer;
begin
...
procedure TPBRPRepsPerformFrm.QRFootPg1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
if noofRecs > 3 then
begin
...
procedure TPBRPRepsPerformFrm.QRFootPg2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
if noofRecs > 7 then
begin
...
function TPBRPRepsPerformFrm.getProfitPerc(sell, cost: real): string;
begin
  if (sell = 0) and (cost = 0) then
      ...
      if (sell = 0) then
        result := '-999%'
         ...
         result := formatfloat('###%',((sell - cost)/cost * 100));
end;
