...
uses
  ...
  ImgList, ToolWin, taoCntrr, taoFrmts, taoMapi, AxCtrls, Clipbrd, pbEnqsdm,
...
procedure TPBMaintCustFrm.taoWinControl1SetDataPaste(Sender: TObject;
  Data: IInterface);
begin
  MyWinControlSetData(Data);
end;

procedure TPBMaintCustFrm.taoWinControl1SetDataTarget(Sender: TObject;
  Data: IInterface; X, Y: Integer);
begin
...
procedure TPBMaintCustFrm.taoWinControl1UpdateAction(Sender: TObject;
  Action: TtaoUpdateAction; var Enable: Boolean);
begin
...
procedure TPBMaintCustFrm.MyWinControlSetData(const Data: IUnknown);
const
...
begin
  if Supports(Data, ItaoCells, MyData) then
    begin
      MyPath := dmBroker.GetCompanyCustomerDirectory + '\' + NameEdit.text +'\';
