object PBLUArtwrkTypFrm: TPBLUArtwrkTypFrm
  Left = 147
  Top = 100
  Caption = 'Look-Up An Artwork Type'
  ClientHeight = 318
  ClientWidth = 451
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Artwork_Instructions'
        Title.Caption = 'Artwork Type'
        Width = 284
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Artwork_Type'
      'Where (Artwork_Type.Artwork_Instructions Like :Code_From)'
      'Order By Artwork_Type.Artwork_Instructions')
    Left = 24
    Top = 24
    ParamData = <
      item
