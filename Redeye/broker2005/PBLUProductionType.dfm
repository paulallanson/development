object PBLUProductionTypeFrm: TPBLUProductionTypeFrm
  Left = 293
  Top = 143
  BorderStyle = bsDialog
  Caption = 'Look-Up Production Type'
  ClientHeight = 299
  ClientWidth = 450
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Production_Type_description'
        Title.Caption = 'Production Type'
        Width = 284
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Production_Type'
        ...
        'Where (Production_Type.Production_Type_Description Like :Code_Fr' +
        'om)'
      'Order By Production_Type.Production_Type_Description'
      ' ')
    Left = 24
    Top = 24
    ParamData = <
