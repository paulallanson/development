object STStkTkslfrm: TSTStkTkslfrm
  Left = 310
  Top = 136
  ...
  object SelectGroupBox: TGroupBox
    ...
    object GroupBox1: TGroupBox
      ...
      object RngFromEdit: TEdit
        ...
        ParentFont = False
        TabOrder = 1
        OnChange = RngFromEditChange
      end
      object RngFromLookupBitBtn: TBitBtn
        Left = 248
        Top = 13
        Width = 25
        Height = 23
        ...
        ParentFont = False
        TabOrder = 2
        OnClick = RngFromLookupBitBtnClick
      end
      object RngToBitBtn: TBitBtn
        Left = 248
        Top = 45
        Width = 25
        Height = 23
    ...
    object PrStkQtyCheckBox: TCheckBox
      Left = 8
      Top = 252
      Width = 169
      Height = 17
      ...
      ParentFont = False
      TabOrder = 4
      OnClick = PrStkQtyCheckBoxClick
    end
    object PrAllBinsCheckBox: TCheckBox
      Left = 8
      Top = 276
      Width = 169
      Height = 17
