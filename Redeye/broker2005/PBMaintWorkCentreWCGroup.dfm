object PBMaintWorkCentreWCGroupFrm: TPBMaintWorkCentreWCGroupFrm
  Left = 344
  Top = 123
  BorderStyle = bsDialog
  Caption = 'Maintain Work Centre Groups'
  ClientHeight = 325
  ClientWidth = 468
  Color = clBtnFace
  ...
  object qryMembers: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where Work_Centre = :Work_Centre and'
      
        'Work_Centre_WC_Group.Work_Centre_Group = Work_Centre_Group.Work_' +
        'Centre_Group')
    Left = 104
    Top = 64
    ParamData = <
