...
type
  TdtmdlStock = class(TDataModule)
    ...
    qryCustStockCustomer_Name: TWideStringField;
    ...
    qryCustStockProduct_Class_Description: TWideStringField;
    ...
    qryPartPOsOrderStatus: TWideStringField;
    qryPartPOsQuantityOrdered: TIntegerField;
    qryPartPOsPackSize: TIntegerField;
    procedure qryCustStockstore_qtyGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartSalesquantity_orderedGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartPOsQuantityOrderedGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartMvmntsStore_QuantityGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartSalesSellValueGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartSalesCostGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartSalesQuantityGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartProductiontot_ord_priceGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartProductiontot_sell_priceGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartProductionQuantityGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryPartSalesJob_Bag_NoGetText(Sender: TField; var Text: String; DisplayText: Boolean);
    procedure qryCustStockFuture_StockGetText(Sender: TField; var Text: String; DisplayText: Boolean);
  private
