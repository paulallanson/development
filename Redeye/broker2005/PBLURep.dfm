object PBLURepFrm: TPBLURepFrm
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active reps'
      Checked = True
      State = cbChecked
      TabOrder = 1
      OnClick = chkbxActiveOnlyClick
    end
    object chkbxIncludeSubReps: TCheckBox
      Left = 8
      Top = 72
      Width = 217
      Height = 16
      Caption = 'Show Sub-Reps'
      Checked = True
      State = cbChecked
      TabOrder = 2
      OnClick = chkbxActiveOnlyClick
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Rep.Position,'
      '        Rep.Product_Nominal_Def,'
      '        Rep.Additional_Dtls_Nominal_Def,'
      '        Rep.Commission_Rate,'
      '        Rep.Rep_Team,'
      '        Rep.Inactive,'
      '        Rep.Rep_Is_Sub_Rep,'
      ...
      'FROM Rep_Team'
      '    RIGHT JOIN Rep'
      '      ON Rep_Team.Rep_Team = Rep.Rep_Team'
      'WHERE (Rep.Name Like :Code_From) and'
      
        '      ((Inactive = '#39'N'#39') or (Inactive is NULL) or (Inactive = :In' +
        'active)) AND'
      
        '      ((Rep_Is_Sub_Rep = '#39'N'#39') or (Rep_Is_Sub_Rep is NULL) or (Re' +
        'p_Is_Sub_Rep = :Rep_Is_Sub_Rep))'
      'ORDER BY Rep.Name')
    Left = 64
    Top = 64
    ParamData = <
