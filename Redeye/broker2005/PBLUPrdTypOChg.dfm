object PBLUPrdTypOChgFrm: TPBLUPrdTypOChgFrm
  Left = 348
  Top = 135
  Caption = 'Look-Up A Product Type Optional Charge'
  ClientHeight = 326
  ClientWidth = 445
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        ...
        Title.Caption = 'Optional Charges'
        Width = 284
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where   (Product_TypeOChg.Product_Type = :Product_Type)'
      'Order By Product_TypeOChg.Description'
      ' '
      ' ')
    Left = 24
    Top = 24
