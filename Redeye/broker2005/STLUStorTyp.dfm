object STLUStorTypFrm: TSTLUStorTypFrm
  Left = 200
  Top = 118
  AutoScroll = False
  Caption = 'Look-Up A Store Type'
  ClientHeight = 313
  ClientWidth = 431
  Color = clBtnFace
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
        ...
        'Select  Part_Store_Type, Part_Store_Type_Name, Part_Store_Is_Van' +
        ','
      
        '        Part_Store_Type.Purchase_Or_Store, Part_Store_Type.Reple' +
        'nish_Store'
      'From Part_Store_Type'
      'Where (Part_Store_Type.Part_Store_Type_Name Like :Code_From)'
