...
type
  TPBPODM = class(TDataModule)
    ...
    UpdSQL: TQuery;
    DelSQL: TQuery;
    UpdPOLinesSQL: TQuery;
    DelPOLineSQL: TQuery;
    UpdPOLineSQL: TQuery;
    AddPOLineSQL: TQuery;
    GetPOLineSQL: TQuery;
    DelPODelivsSQL: TQuery;
    GetPODelivSQL: TQuery;
    UpdPODelivsSQL: TQuery;
    UpdPODelivSQL: TQuery;
    AddPODelivSQL: TQuery;
    GetLineDetsSQL: TQuery;
    GetDelDetsSQL: TQuery;
    AddProofSQL: TQuery;
    DelProofHistorySQL: TQuery;
    GetSuppContSQL: TQuery;
    GetDelPOLinesSQL: TQuery;
    GetLineMemoSQL: TQuery;
    GetExtChgSQL: TQuery;
    UpdExtChgsSQL: TQuery;
    GetExtChgsSQL: TQuery;
    AddExtChgSQL: TQuery;
    UpdExtChgSQL: TQuery;
    DelExtChgsSQL: TQuery;
    UpEnqHeadSQL: TQuery;
    GetStatusSQL: TQuery;
    UpEnqLineSQL: TQuery;
    DelJobBagDetsSQL: TQuery;
    UpdJobBagSQL: TQuery;
    CopyEnqPartDetSQL: TQuery;
    CopyEnqAdditionalsSQL: TQuery;
    DelPOLinePartsSQL: TQuery;
    DelPOAdditionalsSQL: TQuery;
    ...
    AddPartDetSQL: TQuery;
    AddAddDetsSQL: TQuery;
    NCRSQL: TQuery;
    ProductSQL: TQuery;
    StdSizeSQL: TQuery;
    NCRSRC: TDataSource;
    ...
    GetPOSQL: TQuery;
    PriceUnitLUSQL: TQuery;
    CustContactSQL: TQuery;
    GetLastSQL: TQuery;
    UpdLastSQL: TQuery;
    AddSQL: TQuery;
    qryCompany: TQuery;
    ...
    DelPOQuestionsSQL: TQuery;
    AddPOQuestionSQL: TQuery;
    GetNCRDescSQL: TQuery;
    AnyQuestions: TQuery;
    PaperDetailSQL: TQuery;
    qryGeneral: TQuery;
    GetLineProdTypeSQL: TQuery;
    GetPOQuestionSQL: TQuery;
    GetOffContactSQL: TQuery;
    GetSuppContactSQL: TQuery;
    GetLineCallOffsSQL: TQuery;
    GetCompanySQL: TQuery;
    CustContactSRC: TDataSource;
    GetLastJBSQL: TQuery;
    UpdLastJBSQL: TQuery;
    AddJobBagHeadSQL: TQuery;
    AddJobBagSQL: TQuery;
    PriceUnitSQL: TQuery;
    GetDelivLocsSQL: TQuery;
    GetPickLocsSQL: TQuery;
    GetPickSQL: TQuery;
    GetPickQtySQL: TQuery;
    GetPickCallOffSQL: TQuery;
    GetTotPickSQL: TQuery;
    QuestListSQL: TQuery;
    QryStock: TQuery;
    GetLastJBLineSQL: TQuery;
    qryCheckJobBag: TQuery;
    qryGetPOLineIntNotes: TQuery;
    qryInsIntNote: TQuery;
    qryDelPOLineIntNotes: TQuery;
    UpdJobBagHeadSQL: TQuery;
    ChkJobBagLnSQL: TQuery;
    ActionList1: TActionList;
    qryDelExpLife: TQuery;
    updSILineSQL: TQuery;
    GetJBPOStatii: TQuery;
    UpdJobBagHeadStat: TQuery;
    qryVatCode: TQuery;
    dtsVatCode: TDataSource;
    qryVatCodeVat_Code: TIntegerField;
    qryVatCodeVat_Rate: TFloatField;
    qryVatCodeDescription: TStringField;
    qryVatCodeVAT_Ref: TStringField;
    qryGetPOLineDocs: TQuery;
    qryDelPOLineDocs: TQuery;
    qryInsPOLineDocs: TQuery;
    UpJobBagSQL: TQuery;
    CountJBLinesSQL: TQuery;
    VatRateSQL: TQuery;
    qryPOSInvs: TQuery;
    qryPOPInvs: TQuery;
    qryJobType: TQuery;
    dtsJobType: TDataSource;
    qryGetJobType: TQuery;
    qryGetBranchRep: TQuery;
    qrySelActiveCCont: TQuery;
    qryGetAccountMgr: TQuery;
    qryGetProdType: TQuery;
    qryGetAccountTeam: TQuery;
    qryGetOperator: TQuery;
    GetOrigPriceUnitSQL: TQuery;
    qryCheckPI: TQuery;
    qryGetProdTypePriceUnit: TQuery;
    ...
    qryGetTotalUsage: TQuery;
    qryGetTotalStock: TQuery;
    qryUpdPOHist: TQuery;
    GetFldChgTypSQL: TQuery;
    qryGetLastPOHistory: TQuery;
    qryGetPOPriceHist: TQuery;
    ...
    UpdStoreStockSQL: TQuery;
    qryGetPOPriceHistInvoice_Upfront: TStringField;
    qryGetPOProof: TQuery;
    DelPOPriceHistorySQL: TQuery;
    qryFSCClaim: TQuery;
    ...
    GetNCADetsSQL: TQuery;
    qryGetLastNC: TQuery;
    qryUpdateLastNC: TQuery;
    qryDeleteNCA: TQuery;
    qryAddNonConform: TQuery;
    qryGetProduct: TQuery;
    GetStockCodesSQL: TQuery;
    DelPOStockCodesSQL: TQuery;
    qryAddStockCode: TQuery;
    qryGetActiveSupplierContact: TQuery;
    UpdateContactStatusSQL: TQuery;
  ...
  private
    ...
    function BuildAddress(Query : TQuery) : string;
    function BuildBranchAddress(Query: TQuery): string;
    procedure CheckDatabase;
    procedure FixParameters(aQuery : TQuery);
  ...
  public
    ...
    procedure SaveFieldChanges(tempTable: string; DSFrom: TDataSet; SQLTo: TQuery);
...
function TPBPODM.BuildAddress(Query: TQuery): string;
begin
  Result := '';
  with Query do
  begin
...
function TPBPODM.BuildBranchAddress(Query: TQuery): string;
begin
  Result := '';
  with Query do
  begin
...
procedure TPBPODM.FixParameters(aQuery : TQuery);
var
  i : integer;
begin
  with aQuery do
...
procedure TPBPODM.SaveFieldChanges(tempTable: string; DSFrom: TDataSet; SQLTo: TQuery);
var
  iparam: integer;
  iCount: Integer ;
  tempField: TField ;
