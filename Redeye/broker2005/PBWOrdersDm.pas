...
uses
  SysUtils, Classes, DB, DBTables, PBNarrativeDM;
...
type
  ...
  TdtmdlWOrders = class(TDataModule)
    qryWOHeader: TQuery;
    qryWOAddHeader: TQuery;
    qryWOUpHeader: TQuery;
    qryZero: TQuery;
    qryWOHeaderGrid: TQuery;
    dtsWOHeaderGrid: TDataSource;
    qryAllWOrders: TQuery;
    qryOperator: TQuery;
    ...
    qryAddJBHead: TQuery;
    qrySpare: TQuery;
    qryGetProcesses: TQuery;
    qryWOAddProcess: TQuery;
    qryWOProcess: TQuery;
    qryWOAllProcesses: TQuery;
    qryWOEvent: TQuery;
    qryWOAddEvent: TQuery;
    qryWOAllDeliveries: TQuery;
    qryWODelivery: TQuery;
    qryWOAddDelivery: TQuery;
    dtsCourierService: TDataSource;
    qryCourierService: TQuery;
    qryWOAllEvents: TQuery;
    qryGetJBLine: TQuery;
    qryUpdJBHead: TQuery;
    qryWOProcessQstn: TQuery;
    qryWOAddProcessQstn: TQuery;
    qryGetWOQuestions: TQuery;
    qryGetQuestions: TQuery;
    qryGetQuestionList: TQuery;
    qryVatCode: TQuery;
    dtsVatCode: TDataSource;
    dtsCustReps: TDataSource;
    qryAccManager: TQuery;
    dtsAccManager: TDataSource;
    qryGetOpAccountTeam: TQuery;
    qryGetAccountTeam: TQuery;
    qrySelectedWO: TQuery;
    qryPriceUnit: TQuery;
    dtsPriceUnit: TDataSource;
    qryGetPriceUnit: TQuery;
    qryGetJBWO: TQuery;
    qryAddJBWO: TQuery;
    qryUpdWONumber: TQuery;
    qryGetLastWOJB: TQuery;
    qryGetPackage: TQuery;
    qryGetCustomerRep: TQuery;
    qryGetRep: TQuery;
    qryUpWODeliv: TQuery;
    qryUpWOStatus: TQuery;
    qryGetWOStatus: TQuery;
    qryGetJobBagWO: TQuery;
    qryPaperSize: TQuery;
    dtsPaperSize: TDataSource;
    qryGetPaperSize: TQuery;
    qryWOJBProcesses: TQuery;
    qryGetProcessList: TQuery;
    qryGetWIProcess: TQuery;
    qryGetProcess: TQuery;
    dtsProcessPaperSize: TDataSource;
    qryProcessPaperSize: TQuery;
    qryGetOldQuestions: TQuery;
    qryWCGroup: TQuery;
    dtsWCGroup: TDataSource;
    dtsWC: TDataSource;
    qryWC: TQuery;
    OldqryWCGroup: TQuery;
    qryGetCourierService: TQuery;
    qryCourierSort: TQuery;
    dtsCourierSort: TDataSource;
    qryCourierSpeed: TQuery;
