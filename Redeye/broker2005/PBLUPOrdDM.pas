...
type
  TdmLookUpPOrd = class(TDataModule)
    ...
    GetDetsSQLSupp_Name: TWideStringField;
    GetDetsSQLSuppliers_Desc: TWideStringField;
    GetDetsSQLCustomers_Desc: TWideStringField;
    ...
    GetDetsSQLForm_Reference_ID: TWideStringField;
    GetDetsSQLCust_Order_No: TWideStringField;
    GetDetsSQLQuantity: TFloatField;
    GetDetsSQLCustomer_Account_Code: TWideStringField;
    GetDetsSQLSupplier_Account_Code: TWideStringField;
    GetDetsSQLSelling_Price: TCurrencyField;
    GetDetsSQLOrder_Price: TCurrencyField;
    GetDetsSQLOrdering_unit: TWideStringField;
    GetDetsSQLSelling_Unit: TWideStringField;
    GetDetsSQLPurch_Ord_Line_Status: TIntegerField;
    GetDetsSQLStatus_Descr: TWideStringField;
    DummySQL: TFDQuery;
    qryInvoice: TFDQuery;
    GetDetsSQLProof_Revision: TWideStringField;
    UpdSelectedLineSQL: TFDQuery;
    GetDetsSQLOn_Hold: TWideStringField;
