object PBLUCreditReasonFrm: TPBLUCreditReasonFrm
  Left = 272
  Top = 155
  BorderStyle = bsDialog
  Caption = 'Look-Up a Credit Note Reason'
  ClientHeight = 299
  ClientWidth = 450
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Credit_Note_Reason_Descr'
        Title.Caption = 'Credit Reason'
        Width = 287
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where (Credit_Note_Reason_Descr Like :Code_From)'
