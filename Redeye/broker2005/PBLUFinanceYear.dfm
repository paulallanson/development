object PBLUFinanceYearFrm: TPBLUFinanceYearFrm
  Left = 218
  Top = 113
  ...
  object btnRepBudget: TBitBtn
    ...
    Caption = 'Reps'
    TabOrder = 5
    OnClick = btnRepBudgetClick
  end
  object btnCustBudget: TBitBtn
    Left = 238
    Top = 8
    Width = 75
    Height = 25
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '         from Period'
        ...
        '         where Period.Financial_Year = Financial_year.Financial_' +
        'Year) as First_Period_no'
      'From Financial_Year'
      'Where (Title Like :Code_From) '
      'Order By Start_Period_Year')
    Left = 24
    Top = 24
    ParamData = <
      item
  ...
  object qryGetLastFY: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'select Max(Financial_Year) as Last_FY'
      'from Financial_Year')
    Left = 40
    Top = 128
  end
  object qryCheckRepCatBudgets: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'select Rep'
  ...
  object qryCheckRepBudgets: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'select Rep'
      'from Rep_Budget, Period'
      'where Period.Financial_Year = :Financial_Year and'
      'Rep_Budget.Period = Period.Period')
    Left = 256
    Top = 88
    ParamData = <
      item
