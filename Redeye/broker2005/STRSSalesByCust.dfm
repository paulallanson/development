object STRSSalesByCustFrm: TSTRSSalesByCustFrm
  ...
  object Panel1: TPanel
    ...
    object grpbxCust: TGroupBox
      ...
      object chkbxsortbydelivery: TCheckBox
        Left = 134
        Top = 52
        Width = 169
        Height = 17
        Caption = 'sort by delivery address'
        TabOrder = 3
        Visible = False
        OnClick = chkbxsortbydeliveryClick
      end
    end
    object grpbxProduct: TGroupBox
      Left = 8
      Top = 161
      Width = 441
      Height = 77
    ...
    object chkbxShowListPrices: TCheckBox
      Left = 504
      Top = 140
      Width = 169
      Height = 17
      Caption = 'Show List Prices'
      TabOrder = 11
    end
  end
  object chkbxShowClientCodes: TCheckBox
    Left = 504
    Top = 160
    Width = 169
    Height = 17
    Caption = 'Show Customer Codes/Details'
    TabOrder = 3
  end
end
