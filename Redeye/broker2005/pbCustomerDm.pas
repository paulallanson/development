...
type
  TdtmdlCustomers = class(TDataModule)
    ...
    qryCustProdPrefix: TQuery;
    dtsrcCustProdPrefix: TDataSource;
    qryCustomersBase: TQuery;
    qryCustomerLU: TQuery;
    dtsCustomerLU: TDataSource;
    UpdprefixSQL: TQuery;
    qryGetTechCustomer: TQuery;
    qryGetTechContact: TQuery;
    qryEInvoicing: TQuery;
    dtsEInvoicing: TDataSource;
    qryUpdProductStatus: TQuery;
    qryGetEInvoicing: TQuery;
    qryDocuments: TQuery;
    ...
    qryProspectBase: TQuery;
    qryProspects: TQuery;
    qryUpdMulti: TQuery;
    qryUpdMultiBranch: TQuery;
    qryGetOneCustomer: TQuery;
    qryReps: TQuery;
    dtsReps: TDataSource;
    qryDelRepBranch: TQuery;
    qryAddRepBranch: TQuery;
    qryCompanyTypes: TQuery;
    dtsCompanyTypes: TDataSource;
    qryGetAccCodes: TQuery;
    dtsGetAccCodes: TDataSource;
    qryGetImportance: TQuery;
    ...
    qryAddCustomerCat: TQuery;
    qryCustomerCategories: TQuery;
    dtsCustomerCategories: TDataSource;
    qryDelCustomerCat: TQuery;
    qryUpCustomerCatSupply: TQuery;
    qryUpCustomerCatNotes: TQuery;
    qryGetCContactDetails: TQuery;
    qryGetCustomerOrders: TQuery;
    qrySetCustomerInactive: TQuery;
    qryHOContacts: TQuery;
    dtsHOContacts: TDataSource;
    qryGetContactCats: TQuery;
    dtsContactCats: TDataSource;
    qryUpCustomerCatUsed: TQuery;
    qryOperators: TQuery;
    dtsOperators: TDataSource;
    qryDelAccManager: TQuery;
    qryAddAccManager: TQuery;
    qryDelSecondRep: TQuery;
    qryEndUsers: TQuery;
    dtsEndUsers: TDataSource;
    qryEndUserBase: TQuery;
  private
