...
type
  TPBRSJBMarginfrm = class(TForm)
    ...
    qryReportJob_Bag_Line_Descr: TWideStringField;
    ...
    qryReportJob_Bag_Line_Type: TWideStringField;
    ...
    qryReportAnalysis_Code_1: TWideStringField;
    qryReportAnalysis_Code_2: TWideStringField;
