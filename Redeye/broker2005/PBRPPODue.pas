...
uses
  ...
  QuickRpt, QRExpr, Qrctrls, StdCtrls, ExtCtrls, DB, DBTables, CCSPrint, CCSCommon, gtQrCtrls;
...
type
  TPBRPPODueFrm = class(TForm)
    ...
    GetCompSQL: TQuery;
    ODueDateQRLabel: TgtQRLabel;
    SelSuppsQRLabel: TgtQRLabel;
    SupNamQRDBText: TgtQRDBText;
    QRLabel9: TgtQRLabel;
    JobDescrQRDBText: TgtQRDBText;
    QRLabel11: TgtQRLabel;
    DateQRDBText: TgtQRDBText;
    QRLabel10: TgtQRLabel;
    FooterQRBand: TQRBand;
    PageNoQRLabel: TgtQRLabel;
    QRLabel13: TgtQRLabel;
    OurPhoneQRDBText: TgtQRDBText;
    SuppRefQRDBText: TgtQRDBText;
    QRLabel12: TgtQRLabel;
    QtyQRLabel: TgtQRLabel;
    RunDateQRLabel: TgtQRLabel;
    Quantity: TgtQRDBText;
    SelCustQRLabel: TgtQRLabel;
    SupplierNameLbl: TgtQRLabel;
    ReportSelectionLbl: TgtQRLabel;
    QRShape1: TgtQRShape;
    Cust_SuppLbl: TgtQRLabel;
    QRDBText1: TgtQRDBText;
    GetPOsSQL: TQuery;
    QRDBText2: TgtQRDBText;
    QRDBText3: TgtQRDBText;
    OnHoldLbl: TgtQRLabel;
    ...
    qrshpSupplierTerms: TgtQRShape;
    GetNarrSQL: TQuery;
    memSupplierNotes: TgtQRRichText;
