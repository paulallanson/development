...
type
  TDmLookupSOrd = class(TDataModule)
    ...
    qrySalesHistoryPart: TWideStringField;
    ...
    qrySalesHistoryLine_Complete: TWideStringField;
    qrySalesHistoryvat_code: TIntegerField;
    qrySalesHistoryDiscount_Type: TWideStringField;
    ...
    qrySalesHistorydescription: TWideStringField;
    qrySalesHistorydate_ordered: TDateTimeField;
    qrySalesHistorypart_description: TWideStringField;
    qryProductSalesbyCust: TFDQuery;
    qryProductSalesbyCustsales_order: TIntegerField;
    qryProductSalesbyCustpart: TWideStringField;
    qryProductSalesbyCustpart_sales_price: TCurrencyField;
    qryProductSalesbyCustsell_pack_quantity: TIntegerField;
    qryProductSalesbyCustcust_order_no: TWideStringField;
    qryProductSalesbyCustpart_description: TWideStringField;
    qryProductSalesbyCustSalesValue: TFloatField;
    qryProductSalesbyCustProduct: TWideStringField;
    ...
    GetDetsSQLCust_Name: TWideStringField;
    GetDetsSQLBranch_Name: TWideStringField;
    GetDetsSQLDate_Required: TDateTimeField;
    GetDetsSQLSales_Order: TIntegerField;
    GetDetsSQLDate_Ordered: TDateTimeField;
    GetDetsSQLCust_Order_No: TWideStringField;
    ...
    GetDetsSQLPurch_Ord_no: TWideStringField;
    GetDetsSQLStatus_Description: TWideStringField;
    ...
    qryProductSalesbyCustDeliveryLocation: TWideStringField;
    qryProductSalesbyCustDeliveryCustName: TWideStringField;
    qryProductSalesbyCustDeliveryBranchName: TWideStringField;
    qryProductSalesbyCustOrderedBy: TWideStringField;
    GetDetsSQLAd_Hoc_Address: TIntegerField;
    GetDetsSQLDelivery_Customer: TIntegerField;
    GetDetsSQLDel_name: TWideStringField;
    GetDetsSQLDel_To_Add: TWideStringField;
    DummySQL: TFDQuery;
    dummySalesbyCust: TFDQuery;
    qryProdSalesbyCust: TFDQuery;
    qryProdSalesbyCustsales_order: TIntegerField;
    qryProdSalesbyCustpart: TWideStringField;
    qryProdSalesbyCustpart_sales_price: TCurrencyField;
    qryProdSalesbyCustsell_pack_quantity: TIntegerField;
    qryProdSalesbyCustcust_order_no: TWideStringField;
    qryProdSalesbyCustpart_description: TWideStringField;
    qryProdSalesbyCustSalesValue: TFloatField;
    qryProdSalesbyCustProduct: TWideStringField;
    ...
    qryProdSalesbyCustDeliveryLocation: TWideStringField;
    qryProdSalesbyCustDeliveryCustName: TWideStringField;
    qryProdSalesbyCustDeliveryBranchName: TWideStringField;
    qryProdSalesbyCustOrderedBy: TWideStringField;
    qryProdSalesbyCustrep: TIntegerField;
    qryProdSalesbyCustrepName: TWideStringField;
    qryProdSalesbyCustcustomer: TIntegerField;
    qrySalesHistoryDeliveryBranchName: TWideStringField;
    qrySalesHistoryAd_Hoc_Address: TIntegerField;
    qrySalesHistorycust_order_no: TWideStringField;
    qrySalesHistorySales_Value: TFloatField;
    qrySalesHistoryDelivery_Location: TWideStringField;
    qryProdSalesbyCustCost_Centre: TWideStringField;
    qryProdSalesbyCustCustomer_Name: TWideStringField;
    qryProdSalesbyCustBranch_name: TWideStringField;
    qryProdSalesbyCustShort_Code: TWideStringField;
