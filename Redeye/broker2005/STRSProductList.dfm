object STRSProductListFrm: TSTRSProductListFrm
  Left = 368
  Top = 112
  ...
  object grpbxGroups: TGroupBox
    ...
    object btnLUGroups: TSpeedButton
      Left = 232
      Top = 28
      Width = 25
      Height = 25
      Hint = 'Select a specific product group'
      Caption = '...'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
  ...
  object chkbxIncludeInactive: TCheckBox
    ...
    Width = 142
    Height = 17
    Caption = 'Include inactive products'
    TabOrder = 11
  end
  ...
  object chkbxIncludeCosts: TCheckBox
    Left = 395
    Top = 173
    Width = 142
    Height = 17
    Caption = 'Include Cost Details'
    TabOrder = 13
  end
end
