object PBLURevenueLocFrm: TPBLURevenueLocFrm
  Left = 147
  Top = 100
  BorderStyle = bsDialog
  Caption = 'Look-Up Revenue Centre'
  ClientHeight = 318
  ClientWidth = 450
  Color = clBtnFace
  ...
  object SearchGrpBox: TGroupBox
    ...
    object chkbxActiveOnly: TCheckBox
      ...
      Width = 217
      Height = 17
      Caption = 'Only show active revenue centres'
      Checked = True
      State = cbChecked
      TabOrder = 1
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where (Invoice_Location_Descr Like :Code_From) and'
    ...
    object GetDetsSQLInvoice_Payment_Notes: TIntegerField
      FieldName = 'Invoice_Payment_Notes'
    end
  end
  ...
  object UpStatSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Update Invoice_Location'
      'set Default_PM_Revenue_Centre = :Default_PM_Revenue_Centre'
      'where Invoice_Location = :Invoice_Location')
    Left = 208
    Top = 24
    ParamData = <
      item
