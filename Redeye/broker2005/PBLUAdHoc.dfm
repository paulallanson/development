object PBLUAdHocFrm: TPBLUAdHocFrm
  Left = 205
  Top = 135
  BorderStyle = bsDialog
  Caption = 'Look-Up An Ad-Hoc Address'
  ClientHeight = 299
  ClientWidth = 433
  Color = clBtnFace
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        Ad_Hoc_Address.Name,'
      '        Ad_Hoc_Address.Building_No_Name,'
      '        Ad_Hoc_Address.Street,'
      '        Ad_Hoc_Address.Locale,'
      '        Ad_Hoc_Address.PostCode,'
      '        Ad_Hoc_Address.Town,'
      '        Ad_Hoc_Address.Narrative,'
      '        Ad_Hoc_Address.Delivery_Narrative'
      'From Ad_Hoc_Address'
      'Where (Ad_Hoc_Address.Name Like :Code_From) and'
      '  ((Customer = :Customer) or (:Customer = 0))'
      'Order By Ad_Hoc_Address.Name')
    Left = 24
    Top = 24
    ParamData = <
      item
