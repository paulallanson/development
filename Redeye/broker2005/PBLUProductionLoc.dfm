object PBLUProductionLocfrm: TPBLUProductionLocfrm
  Left = 205
  Top = 135
  BorderStyle = bsDialog
  Caption = 'Look-up Production Location'
  ClientHeight = 299
  ClientWidth = 433
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Production_Location_Name'
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'From Production_Location'
        ...
        'Where (Production_Location.Production_Location_Name Like :Code_F' +
        'rom)'
      'Order By Production_Location.Production_Location_Name')
    Left = 24
    Top = 24
    ParamData = <
      item
