object PBLUNonConformDeptFrm: TPBLUNonConformDeptFrm
  Left = 215
  Top = 128
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Non_Conform_Dept_Descr'
        Title.Caption = 'Non Conformance Department'
        Width = 284
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ...
    SQL.Strings = (
      ...
      'Where Non_Conform_Dept_Descr LIKE :Code_From AND'
