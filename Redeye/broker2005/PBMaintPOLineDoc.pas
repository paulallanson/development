...
type
  TPBMaintPOLineDocFrm = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    edtTitle: TEdit;
    edtLocation: TEdit;
...
function TPBMaintPOLineDocFrm.New: TDocument;
var
  document: TDocument;
begin
  result := nil;
...
procedure TPBMaintPOLineDocFrm.Delete(document: TDocument);
begin
...
procedure TPBMaintPOLineDocFrm.Edit(document: TDocument);
begin
  self.edtTitle.Text := document.Title;
  self.edtLocation.Text := document.Path;
...
procedure TPBMaintPOLineDocFrm.btnBrowseClick(Sender: TObject);
var
