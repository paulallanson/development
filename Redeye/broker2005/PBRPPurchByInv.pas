...
type
  TPBRPPurchByInvFrm = class(TForm)
    ...
    qryPurchbyInvInvoiceRef: TStringField;
    qryPurchbyInvsupplierName: TStringField;
    QRDBText1: TQRDBText;
    qryPurchbyInvAccount_Code: TStringField;
    qryPurchbyInvSupp_Inv_Alt_Ref: TStringField;
