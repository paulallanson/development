...
function TPBRPQuoteCustFrm.PrepareReport(tmpdateFrom, tmpdateTo: TDateTime; customer, branch, rep: integer): integer;
{ Local function }
...
procedure TPBRPQuoteCustFrm.qrbDetailsBeforePrint(
...
procedure TPBRPQuoteCustFrm.qrbndReasFtrBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TPBRPQuoteCustFrm.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var
  tempstr: string;
begin
