...
type
  TPBRSCustContDetFrm = class(TForm)
    ...
    qryContStatusContact_Status_descr: TStringField;
    Label8: TLabel;
    ...
    qryCurrentContStatusMobile_No: TStringField;
    qryCurrentContStatusContact_Fax: TStringField;
    ...
    qryCurrentContStatusContact_Status_Descr: TStringField;
    qryCurrentContStatusBuilding_No_name: TStringField;
    qryCurrentContStatusStreet: TStringField;
    qryCurrentContStatusLocale: TStringField;
    qryCurrentContStatusTown: TStringField;
    qryCurrentContStatusPostcode: TStringField;
    qryCurrentContStatusCustomer_Phone: TStringField;
    qryCurrentContStatusCustomer_Fax: TStringField;
    qryCurrentContStatusCustomer_Name: TStringField;
    qryCurrentContStatusRep_Name: TStringField;
    ...
    qryCurrentContStatusAcc_Active: TStringField;
    qryCurrentContStatusContact_Level_Description: TStringField;
    ...
    qryCurrentContStatusSub_Rep_Name: TStringField;
