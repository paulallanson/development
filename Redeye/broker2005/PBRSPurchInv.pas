...
type
  TPBRSPurchInvFrm = class(TForm)
    ...
    OldqryPurchInvCustomer_Name: TWideStringField;
    OldqryPurchInvCustomers_Desc: TWideStringField;
    OldqryPurchInvSales_Qty: TFloatField;
    OldqryPurchInvSell_Price: TCurrencyField;
    OldqryPurchInvSales_Invoice_No: TWideStringField;
    OldqryPurchInvSales_Invoice_Date: TDateTimeField;
    OldqryPurchInvSupplier_Name: TWideStringField;
    ...
    qryPurchInvCustomer_Name: TWideStringField;
    qryPurchInvCustomers_Desc: TWideStringField;
    ...
    qryPurchInvSupplier_Name: TWideStringField;
    qryPurchInvSales_invoice_no: TWideStringField;
    qryPurchInvSales_invoice_date: TDateTimeField;
    qryPurchInvSupplier_invoice_no: TWideStringField;
    qryPurchInvSupplier_invoice_date: TDateTimeField;
    qryPurchInvRep_Name: TWideStringField;
    qryPurchInvPOLine: TWideStringField;
