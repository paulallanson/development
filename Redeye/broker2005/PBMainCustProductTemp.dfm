object PBMaintCustProductTempFrm: TPBMaintCustProductTempFrm
  ...
  object GetLastSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select Credit_Note_Reason'
      'From Credit_Note_Reason'
      'Where Credit_Note_Reason_Descr = :GUID'
      ' ')
    Left = 192
    Top = 24
    ParamData = <
  ...
  object AddSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Insert Into Credit_Note_Reason'
      '        (Credit_Note_Reason,'
      '        Credit_Note_Reason_Descr)'
      'Select Max(Credit_Note_Reason)+1, :GUID From Credit_Note_Reason'
      ''
      ''
      ''
      ' '
  ...
  object UpdSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Update Credit_Note_Reason'
      'Set     Credit_Note_Reason_Descr = :Credit_Note_Reason_Descr '
      'Where'
  ...
  object DelSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Delete From Credit_Note_Reason'
      'Where'
      '(Credit_Note_Reason = :Credit_Note_Reason)'
      ' ')
    Left = 240
