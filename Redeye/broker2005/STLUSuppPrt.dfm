object STLUSuppPrtFrm: TSTLUSuppPrtFrm
  Left = 147
  Top = 100
  BorderStyle = bsDialog
  Caption = 'Look-Up Supplier Product Details'
  ClientHeight = 306
  ClientWidth = 556
  Color = clBtnFace
  ...
  object DetsDBGrid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'Supplier_Part_Code'
        Title.Caption = 'Supplier Part Code'
        Width = 177
        Visible = True
      end>
  end
  ...
  object GetDetsSQL: TFDQuery
    ConnectionName = 'PB'
    SQL.Strings = (
      'Select  Part_Supplier.*,'
      '        Part.Part_Description,'
      
        '        Supplier.Name as Supplier_Name, Supplier_Branch.Name as ' +
        'Branch_Name'
      'From Part_Supplier, Supplier, Supplier_Branch, Part'
      'Where '
      ...
      '('
      '(Part_Supplier.Supplier = Supplier_Branch.Supplier) and'
      '(Part_Supplier.Branch_no = Supplier_Branch.Branch_no)'
      ') '
