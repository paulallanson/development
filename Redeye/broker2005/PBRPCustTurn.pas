...
function TPBRPCustTurnFrm.GetDetails: integer;
begin
  fixquery(True);
...
procedure TPBRPCustTurnFrm.qckrpSalesByInvBeforePrint(
...
procedure TPBRPCustTurnFrm.setSeqByCost(const Value: Boolean);
begin
  fSeqByCost := Value;
end;

procedure TPBRPCustTurnFrm.setSeqBySales(const Value: Boolean);
begin
  fSeqBySales := Value;
end;

procedure TPBRPCustTurnFrm.SetSeqByProfit(const Value: Boolean);
begin
  FSeqByProfit := Value;
end;

procedure TPBRPCustTurnFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  rTotalCost :real;
begin
...
procedure TPBRPCustTurnFrm.QryCustTurnCalcFields(DataSet: TDataSet);
begin
...
procedure TPBRPCustTurnFrm.FixQuery(rep: Boolean);
begin
...
function TPBRPCustTurnFrm.BuildQueryString(rep: Boolean): string;
var
stemp : string;
begin
...
procedure TPBRPCustTurnFrm.SetSeqByMargPerc(const Value: Boolean);
begin
  fSeqByMargPerc := Value;
end;

procedure TPBRPCustTurnFrm.SetOrderasc(const Value: Boolean);
begin
  fOrderasc := Value;
end;

procedure TPBRPCustTurnFrm.setNoofCust(const Value: integer);
begin
  fnoofcust := Value;
end;

procedure TPBRPCustTurnFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
RepMrgPerc : real;
begin
...
procedure TPBRPCustTurnFrm.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
RepCst := 0.;
RepSel := 0.;
...
procedure TPBRPCustTurnFrm.ExportToFile(fileName: string);
var
  tempStr: string;
begin
  self.exporting := true;
...
procedure TPBRPCustTurnFrm.QRSubDetail1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var
  tempStr: string;
begin
...
procedure TPBRPCustTurnFrm.SetSeqbyName(const Value: boolean);
begin
  FSeqbyName := Value;
end;
