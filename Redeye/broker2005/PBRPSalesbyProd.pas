...
type
  TPBRPSalesbyProdFrm = class(TForm)
    ...
    qrySalesbyProdCredit_type: TWideStringField;
    qrySalesbyProdInvoice_Date: TDateTimeField;
    qrySalesbyProdSales_Invoice_No: TWideStringField;
    ...
    qrySalesbyProdCustomer_Name: TWideStringField;
    qrySalesbyProdBranch_Name: TWideStringField;
    qrySalesbyProdDescription: TWideStringField;
    ...
    qrySalesbyProdInvoiceRef: TWideStringField;
    ...
    qrySalesbyProdOrder: TWideStringField;
    qrmmAddChrg: TQRMemo;
    qrmmAddChrgPrice: TQRMemo;
    qryInvAddChrgs: TFDQuery;
    qryInvAddChrgsdetails: TWideStringField;
    ...
    QRlblCst: TQRLabel;
    QRLblPrft: TQRLabel;
    qrySalesbyProdInvoice_Or_Credit: TWideStringField;
    qrySalesbyProdSales_Invoice_Type: TWideStringField;
    qrySalesbyProdReference: TWideStringField;
